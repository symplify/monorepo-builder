...
final class SortedParameterMerger
{
     ...
     */
    private $arraySorter;
    public function __construct(\MonorepoBuilder20211007\Symplify\PackageBuilder\Yaml\ParametersMerger $parametersMerger, \Symplify\MonorepoBuilder\Merge\Arrays\ArraySorter $arraySorter)
    {
