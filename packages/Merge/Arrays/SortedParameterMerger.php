...
final class SortedParameterMerger
{
     ...
     */
    private $arraySorter;
    public function __construct(\MonorepoBuilder20211128\Symplify\PackageBuilder\Yaml\ParametersMerger $parametersMerger, \Symplify\MonorepoBuilder\Merge\Arrays\ArraySorter $arraySorter)
    {
