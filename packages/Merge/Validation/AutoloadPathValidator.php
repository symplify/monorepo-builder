...
final class AutoloadPathValidator
{
    ...
    public function __construct(\MonorepoBuilder20220313\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
        $this->fileSystemGuard = $fileSystemGuard;
    }
    public function ensureAutoloadPathExists(\MonorepoBuilder20220313\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
        $composerJsonFileInfo = $composerJson->getFileInfo();
        if (!$composerJsonFileInfo instanceof \MonorepoBuilder20220313\Symplify\SmartFileSystem\SmartFileInfo) {
            return;
        }
