...
use MonorepoBuilder20220606\Symplify\ComposerJsonManipulator\ComposerJsonFactory;
...
final class MergeCommand extends \MonorepoBuilder20220606\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \MonorepoBuilder20220606\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, \MonorepoBuilder20220606\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager, \Symplify\MonorepoBuilder\Merge\Application\MergedAndDecoratedComposerJsonFactory $mergedAndDecoratedComposerJsonFactory, \Symplify\MonorepoBuilder\Validator\SourcesPresenceValidator $sourcesPresenceValidator, \Symplify\MonorepoBuilder\Merge\Guard\ConflictingVersionsGuard $conflictingVersionsGuard)
    {
    ...
    private function getRootComposerJson(string $rootComposerJsonFilePath) : \MonorepoBuilder20220606\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
