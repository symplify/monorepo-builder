...
final class RemoverComposerJsonDecorator implements \Symplify\MonorepoBuilder\Merge\Contract\ComposerJsonDecoratorInterface
{
    ...
    public function decorate(\MonorepoBuilder20220529\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : void
    {
        $removingComposerJson = $this->modifyingComposerJsonProvider->getRemovingComposerJson();
        if (!$removingComposerJson instanceof \MonorepoBuilder20220529\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson) {
            return;
        }
    ...
    private function processRequire(\MonorepoBuilder20220529\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20220529\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJsonToRemove) : void
    {
    ...
    private function processRequireDev(\MonorepoBuilder20220529\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20220529\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJsonToRemove) : void
    {
    ...
    private function processAutoload(\MonorepoBuilder20220529\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20220529\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJsonToRemove) : void
    {
    ...
    private function processAutoloadDev(\MonorepoBuilder20220529\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20220529\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJsonToRemove) : void
    {
    ...
    private function processRoot(\MonorepoBuilder20220529\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20220529\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $removingComposerJson) : void
    {
