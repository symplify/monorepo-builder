...
final class RemoverComposerJsonDecorator implements \Symplify\MonorepoBuilder\Merge\Contract\ComposerJsonDecoratorInterface
{
    ...
    public function decorate($composerJson) : void
    {
        ...
        if (!$removingComposerJson instanceof \MonorepoBuilder20211120\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson) {
            return;
        }
    ...
    private function processRequire(\MonorepoBuilder20211120\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20211120\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJsonToRemove) : void
    {
    ...
    private function processRequireDev(\MonorepoBuilder20211120\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20211120\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJsonToRemove) : void
    {
    ...
    private function processAutoload(\MonorepoBuilder20211120\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20211120\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJsonToRemove) : void
    {
    ...
    private function processAutoloadDev(\MonorepoBuilder20211120\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20211120\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJsonToRemove) : void
    {
    ...
    private function processRoot(\MonorepoBuilder20211120\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20211120\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $removingComposerJson) : void
    {
