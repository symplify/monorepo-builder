...
final class RemoverComposerJsonDecorator implements \Symplify\MonorepoBuilder\Merge\Contract\ComposerJsonDecoratorInterface
{
    ...
    public function decorate($composerJson) : void
    {
        ...
        if (!$removingComposerJson instanceof \MonorepoBuilder20210930\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson) {
            return;
        }
    ...
    private function processRequire(\MonorepoBuilder20210930\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20210930\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJsonToRemove) : void
    {
    ...
    private function processRequireDev(\MonorepoBuilder20210930\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20210930\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJsonToRemove) : void
    {
    ...
    private function processAutoload(\MonorepoBuilder20210930\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20210930\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJsonToRemove) : void
    {
    ...
    private function processAutoloadDev(\MonorepoBuilder20210930\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20210930\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJsonToRemove) : void
    {
    ...
    private function processRoot(\MonorepoBuilder20210930\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, \MonorepoBuilder20210930\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $removingComposerJson) : void
    {
