...
final class ModifyingComposerJsonProvider
{
    ...
    public function __construct(\MonorepoBuilder20210801\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, \MonorepoBuilder20210801\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
        $this->composerJsonFactory = $composerJsonFactory;
        $this->parameterProvider = $parameterProvider;
    }
    public function getRemovingComposerJson() : ?\MonorepoBuilder20210801\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
    ...
    public function getAppendingComposerJson() : ?\MonorepoBuilder20210801\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
