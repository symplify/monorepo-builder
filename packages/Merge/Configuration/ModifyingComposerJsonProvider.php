...
final class ModifyingComposerJsonProvider
{
    ...
    public function __construct(\MonorepoBuilder20210802\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, \MonorepoBuilder20210802\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
        $this->composerJsonFactory = $composerJsonFactory;
        $this->parameterProvider = $parameterProvider;
    }
    public function getRemovingComposerJson() : ?\MonorepoBuilder20210802\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
    ...
    public function getAppendingComposerJson() : ?\MonorepoBuilder20210802\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
