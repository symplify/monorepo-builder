...
final class ModifyingComposerJsonProvider
{
    ...
    public function __construct(\MonorepoBuilder20220306\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, \MonorepoBuilder20220306\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
        $this->composerJsonFactory = $composerJsonFactory;
        $this->parameterProvider = $parameterProvider;
    }
    public function getRemovingComposerJson() : ?\MonorepoBuilder20220306\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
    ...
    public function getAppendingComposerJson() : ?\MonorepoBuilder20220306\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
