...
final class ModifyingComposerJsonProvider
{
    ...
    public function __construct(\MonorepoBuilder20211216\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory, \MonorepoBuilder20211216\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
        $this->composerJsonFactory = $composerJsonFactory;
        $this->parameterProvider = $parameterProvider;
    }
    public function getRemovingComposerJson() : ?\MonorepoBuilder20211216\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
    ...
    public function getAppendingComposerJson() : ?\MonorepoBuilder20211216\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
