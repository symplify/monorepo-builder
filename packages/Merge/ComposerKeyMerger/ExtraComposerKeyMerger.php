...
final class ExtraComposerKeyMerger implements ComposerKeyMergerInterface
{
     ...
     */
    private $sorted_parameter_merger;
    /**
     * @var string
     */
    private const PHPSTAN = 'phpstan';
    public function __construct(SortedParameterMerger $sorted_parameter_merger)
    {
        $this->sorted_parameter_merger = $sorted_parameter_merger;
    }
