...
final class RepositoriesComposerKeyMerger implements ComposerKeyMergerInterface
{
    ...
    public function merge(ComposerJson $mainComposerJson, ComposerJson $newComposerJson) : void
    {
        ...
        $repositories = $this->sortedParameterMerger->mergeRecursiveAndSort(ComposerJsonSection::REPOSITORIES, $mainComposerJson->getRepositories(), $newComposerJson->getRepositories());
