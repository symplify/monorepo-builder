...
final class VersionFactory
{
    ...
    public function createValidVersion(string $versionArgument, string $stage) : \MonorepoBuilder20210706\PharIo\Version\Version
    {
        ...
        $version = new \MonorepoBuilder20210706\PharIo\Version\Version($versionArgument);
        $this->releaseGuard->guardVersion($version, $stage);
        return $version;
    }
    private function resolveNextVersionByVersionKind(string $versionKind) : \MonorepoBuilder20210706\PharIo\Version\Version
    {
        // get current version
        $mostRecentVersion = $this->mostRecentTagResolver->resolve(\getcwd());
        if ($mostRecentVersion === null) {
            // the very first tag
            return new \MonorepoBuilder20210706\PharIo\Version\Version('v0.1.0');
        }
        ...
        return new \MonorepoBuilder20210706\PharIo\Version\Version(\sprintf('%d.%d.%d', $value, $currentMinorVersion, $currentPatchVersion));
    }
}
