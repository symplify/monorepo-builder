...
use MonorepoBuilder20211117\Symplify\EasyCI\Exception\ShouldNotHappenException;
...
final class UpdateReplaceReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work($version) : void
    {
        ...
        if (!$rootFileInfo instanceof \MonorepoBuilder20211117\Symplify\SmartFileSystem\SmartFileInfo) {
            throw new \MonorepoBuilder20211117\Symplify\EasyCI\Exception\ShouldNotHappenException();
        }
