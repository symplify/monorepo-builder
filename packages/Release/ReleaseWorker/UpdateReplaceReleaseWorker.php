...
use MonorepoBuilder20211219\Symplify\EasyCI\Exception\ShouldNotHappenException;
...
final class UpdateReplaceReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\PharIo\Version\Version $version) : void
    {
        ...
        if (!$rootFileInfo instanceof \MonorepoBuilder20211219\Symplify\SmartFileSystem\SmartFileInfo) {
            throw new \MonorepoBuilder20211219\Symplify\EasyCI\Exception\ShouldNotHappenException();
        }
