...
use MonorepoBuilder20210927\Symplify\EasyCI\Exception\ShouldNotHappenException;
...
final class UpdateReplaceReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work($version) : void
    {
        ...
        if (!$rootFileInfo instanceof \MonorepoBuilder20210927\Symplify\SmartFileSystem\SmartFileInfo) {
            throw new \MonorepoBuilder20210927\Symplify\EasyCI\Exception\ShouldNotHappenException();
        }
