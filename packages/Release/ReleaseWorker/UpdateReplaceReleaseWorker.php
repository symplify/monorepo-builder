...
use MonorepoBuilder20211001\Symplify\EasyCI\Exception\ShouldNotHappenException;
...
final class UpdateReplaceReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work($version) : void
    {
        ...
        if (!$rootFileInfo instanceof \MonorepoBuilder20211001\Symplify\SmartFileSystem\SmartFileInfo) {
            throw new \MonorepoBuilder20211001\Symplify\EasyCI\Exception\ShouldNotHappenException();
        }
