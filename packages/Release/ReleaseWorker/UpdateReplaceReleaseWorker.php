...
use MonorepoBuilder20220414\Symplify\EasyCI\Exception\ShouldNotHappenException;
...
final class UpdateReplaceReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function __construct(\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \MonorepoBuilder20220414\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager)
    {
    ...
    public function work(\PharIo\Version\Version $version) : void
    {
        ...
        if (!$rootFileInfo instanceof \MonorepoBuilder20220414\Symplify\SmartFileSystem\SmartFileInfo) {
            throw new \MonorepoBuilder20220414\Symplify\EasyCI\Exception\ShouldNotHappenException();
        }
