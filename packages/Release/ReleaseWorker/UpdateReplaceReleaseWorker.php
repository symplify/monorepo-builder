...
use MonorepoBuilder20220306\Symplify\EasyCI\Exception\ShouldNotHappenException;
...
final class UpdateReplaceReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work(\PharIo\Version\Version $version) : void
    {
        ...
        if (!$rootFileInfo instanceof \MonorepoBuilder20220306\Symplify\SmartFileSystem\SmartFileInfo) {
            throw new \MonorepoBuilder20220306\Symplify\EasyCI\Exception\ShouldNotHappenException();
        }
