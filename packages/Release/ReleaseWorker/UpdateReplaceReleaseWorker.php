...
use MonorepoBuilder20211209\Symplify\EasyCI\Exception\ShouldNotHappenException;
...
final class UpdateReplaceReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function work($version) : void
    {
        ...
        if (!$rootFileInfo instanceof \MonorepoBuilder20211209\Symplify\SmartFileSystem\SmartFileInfo) {
            throw new \MonorepoBuilder20211209\Symplify\EasyCI\Exception\ShouldNotHappenException();
        }
