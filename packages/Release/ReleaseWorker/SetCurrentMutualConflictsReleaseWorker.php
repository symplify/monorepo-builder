...
final class SetCurrentMutualConflictsReleaseWorker implements ReleaseWorkerInterface
{
    ...
    {
        $this->conflictingUpdater->updateFilePathsWithVendorAndVersion($this->composerJsonProvider->getPackagesComposerFileInfos(), $this->packageNamesProvider->provide(), $version);
