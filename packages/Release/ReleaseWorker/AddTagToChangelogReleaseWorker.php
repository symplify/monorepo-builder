...
use MonorepoBuilder20211210\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function __construct(\MonorepoBuilder20211210\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    {
        $dateTime = new \MonorepoBuilder20211210\Nette\Utils\DateTime();
