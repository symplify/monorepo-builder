...
use MonorepoBuilder20211104\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function __construct(\MonorepoBuilder20211104\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    public function work($version) : void
    {
        ...
        $changelogFileContent = \MonorepoBuilder20211104\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    {
        $dateTime = new \MonorepoBuilder20211104\Nette\Utils\DateTime();
