...
use MonorepoBuilder20210822\Nette\Utils\DateTime;
...
final class AddTagToChangelogReleaseWorker implements \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface
{
    ...
    public function __construct(\MonorepoBuilder20210822\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
    ...
    public function work($version) : void
    {
        ...
        $changelogFileContent = \MonorepoBuilder20210822\Nette\Utils\Strings::replace($changelogFileContent, self::UNRELEASED_HEADLINE_REGEX, '## ' . $newHeadline);
    ...
    {
        $dateTime = new \MonorepoBuilder20210822\Nette\Utils\DateTime();
