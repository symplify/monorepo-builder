...
use MonorepoBuilder20220511\Symplify\PackageBuilder\Console\Command\CommandNaming;
final class ReleaseCommand extends \MonorepoBuilder20220511\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    {
        $this->setName(\MonorepoBuilder20220511\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(self::class));
        ...
        $this->addArgument(\Symplify\MonorepoBuilder\ValueObject\Option::VERSION, \MonorepoBuilder20220511\Symfony\Component\Console\Input\InputArgument::REQUIRED, $description);
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::DRY_RUN, null, \MonorepoBuilder20220511\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Do not perform operations, just their preview');
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::STAGE, null, \MonorepoBuilder20220511\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Name of stage to perform', \Symplify\MonorepoBuilder\Release\ValueObject\Stage::MAIN);
    }
