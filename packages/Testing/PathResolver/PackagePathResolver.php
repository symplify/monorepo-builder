...
final class PackagePathResolver
{
     ...
     */
    public function resolveRelativePathToLocalPackage(\MonorepoBuilder20211002\Symplify\SmartFileSystem\SmartFileInfo $rootComposerFileInfo, \MonorepoBuilder20211002\Symplify\SmartFileSystem\SmartFileInfo $packageComposerFileInfo) : string
    {
     ...
     * See https://getcomposer.org/doc/05-repositories.md#path
     */
    public function resolveRelativeFolderPathToLocalPackage(\MonorepoBuilder20211002\Symplify\SmartFileSystem\SmartFileInfo $rootComposerFileInfo, \MonorepoBuilder20211002\Symplify\SmartFileSystem\SmartFileInfo $packageComposerFileInfo) : string
    {
    ...
    public function resolveRelativeDirectoryToRoot(\MonorepoBuilder20211002\Symplify\SmartFileSystem\SmartFileInfo $rootComposerFileInfo, \MonorepoBuilder20211002\Symplify\SmartFileSystem\SmartFileInfo $packageComposerFileInfo) : string
    {
