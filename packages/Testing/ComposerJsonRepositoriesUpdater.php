...
use MonorepoBuilder20220305\Symplify\PackageBuilder\Console\Output\ConsoleDiffer;
...
final class ComposerJsonRepositoriesUpdater
{
    ...
    public function __construct(\Symplify\MonorepoBuilder\Package\PackageNamesProvider $packageNamesProvider, \MonorepoBuilder20220305\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager, \MonorepoBuilder20220305\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \Symplify\MonorepoBuilder\Testing\ComposerJson\ComposerJsonSymlinker $composerJsonSymlinker, \Symplify\MonorepoBuilder\Testing\PackageDependency\UsedPackagesResolver $usedPackagesResolver, \MonorepoBuilder20220305\Symplify\PackageBuilder\Console\Output\ConsoleDiffer $consoleDiffer)
    {
    ...
    public function processPackage(\MonorepoBuilder20220305\Symplify\SmartFileSystem\SmartFileInfo $packageFileInfo, \MonorepoBuilder20220305\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $rootComposerJson, bool $symlink) : void
    {
        ...
        if (!$rootComposerJsonFileInfo instanceof \MonorepoBuilder20220305\Symplify\SmartFileSystem\SmartFileInfo) {
