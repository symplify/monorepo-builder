...
namespace MonorepoBuilder20210705\Symplify\MonorepoBuilder\Testing;
...
use MonorepoBuilder20210705\Symplify\ConsoleColorDiff\Console\Output\ConsoleDiffer;
use MonorepoBuilder20210705\Symplify\MonorepoBuilder\Package\PackageNamesProvider;
use MonorepoBuilder20210705\Symplify\MonorepoBuilder\Testing\ComposerJson\ComposerJsonSymlinker;
use MonorepoBuilder20210705\Symplify\MonorepoBuilder\Testing\PackageDependency\UsedPackagesResolver;
...
final class ComposerJsonRepositoriesUpdater
{
    ...
    public function __construct(\MonorepoBuilder20210705\Symplify\MonorepoBuilder\Package\PackageNamesProvider $packageNamesProvider, \MonorepoBuilder20210705\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager, \MonorepoBuilder20210705\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \MonorepoBuilder20210705\Symplify\MonorepoBuilder\Testing\ComposerJson\ComposerJsonSymlinker $composerJsonSymlinker, \MonorepoBuilder20210705\Symplify\MonorepoBuilder\Testing\PackageDependency\UsedPackagesResolver $usedPackagesResolver, \MonorepoBuilder20210705\Symplify\ConsoleColorDiff\Console\Output\ConsoleDiffer $consoleDiffer)
    {
    ...
    public function processPackage(\MonorepoBuilder20210705\Symplify\SmartFileSystem\SmartFileInfo $packageFileInfo, \MonorepoBuilder20210705\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $rootComposerJson, bool $symlink) : void
    {
        ...
        if (!$rootComposerJsonFileInfo instanceof \MonorepoBuilder20210705\Symplify\SmartFileSystem\SmartFileInfo) {
            throw new \MonorepoBuilder20210705\Symplify\SymplifyKernel\Exception\ShouldNotHappenException();
        }
        $packageComposerJson = $this->composerJsonSymlinker->decoratePackageComposerJsonWithPackageSymlinks($packageFileInfo, $packageNames, $rootComposerJsonFileInfo, $symlink);
