...
final class LocalizeComposerPathsCommand extends \MonorepoBuilder20211107\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\MonorepoBuilder\Testing\ValueObject\Option::PACKAGE_COMPOSER_JSON, \MonorepoBuilder20211107\Symfony\Component\Console\Input\InputArgument::REQUIRED, 'Path to package "composer.json"');
    }
    /**
    ...
    protected function execute($input, $output) : int
    {
        ...
        $packageComposerJsonFileInfo = new \MonorepoBuilder20211107\Symplify\SmartFileSystem\SmartFileInfo($packageComposerJson);
