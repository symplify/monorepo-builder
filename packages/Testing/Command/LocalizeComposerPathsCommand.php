...
final class LocalizeComposerPathsCommand extends \MonorepoBuilder20220527\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\MonorepoBuilder\Testing\ValueObject\Option::PACKAGE_COMPOSER_JSON, \MonorepoBuilder20220527\Symfony\Component\Console\Input\InputArgument::REQUIRED, 'Path to package "composer.json"');
    }
    protected function execute(\MonorepoBuilder20220527\Symfony\Component\Console\Input\InputInterface $input, \MonorepoBuilder20220527\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $packageComposerJsonFileInfo = new \MonorepoBuilder20220527\Symplify\SmartFileSystem\SmartFileInfo($packageComposerJson);
