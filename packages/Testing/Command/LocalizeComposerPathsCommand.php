...
final class LocalizeComposerPathsCommand extends \MonorepoBuilder20211029\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\Symplify\MonorepoBuilder\Testing\ValueObject\Option::PACKAGE_COMPOSER_JSON, \MonorepoBuilder20211029\Symfony\Component\Console\Input\InputArgument::REQUIRED, 'Path to package "composer.json"');
    }
    /**
    ...
    protected function execute($input, $output) : int
    {
        ...
        $packageComposerJsonFileInfo = new \MonorepoBuilder20211029\Symplify\SmartFileSystem\SmartFileInfo($packageComposerJson);
