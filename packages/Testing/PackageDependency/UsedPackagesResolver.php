...
final class UsedPackagesResolver
{
    ...
    {
        $usedPackageNames = [];
        foreach ([\MonorepoBuilder20210921\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE, \MonorepoBuilder20210921\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE_DEV] as $section) {
