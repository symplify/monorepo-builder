...
use MonorepoBuilder20220524\Symplify\Astral\Exception\ShouldNotHappenException;
...
final class PropagateCommand extends \MonorepoBuilder20220524\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \Symplify\MonorepoBuilder\Propagate\VersionPropagator $versionPropagator, \MonorepoBuilder20220524\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager)
    {
    ...
    protected function execute(\MonorepoBuilder20220524\Symfony\Component\Console\Input\InputInterface $input, \MonorepoBuilder20220524\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        foreach ($this->composerJsonProvider->getPackageComposerJsons() as $packageComposerJson) {
            ...
            if (!$packageFileInfo instanceof \MonorepoBuilder20220524\Symplify\SmartFileSystem\SmartFileInfo) {
                throw new \MonorepoBuilder20220524\Symplify\Astral\Exception\ShouldNotHappenException();
            }
