...
use MonorepoBuilder20211204\Symplify\Astral\Exception\ShouldNotHappenException;
...
use MonorepoBuilder20211204\Symplify\PackageBuilder\Console\Command\CommandNaming;
use MonorepoBuilder20211204\Symplify\SmartFileSystem\SmartFileInfo;
final class PropagateCommand extends \MonorepoBuilder20211204\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \Symplify\MonorepoBuilder\Propagate\VersionPropagator $versionPropagator, \MonorepoBuilder20211204\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager)
    {
    ...
    {
        $this->setName(\MonorepoBuilder20211204\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(self::class));
    ...
    protected function execute($input, $output) : int
    {
        ...
        foreach ($this->composerJsonProvider->getPackageComposerJsons() as $packageComposerJson) {
            ...
            if (!$packageFileInfo instanceof \MonorepoBuilder20211204\Symplify\SmartFileSystem\SmartFileInfo) {
                throw new \MonorepoBuilder20211204\Symplify\Astral\Exception\ShouldNotHappenException();
            }
