...
final class PropagateCommand extends \MonorepoBuilder20220527\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \Symplify\MonorepoBuilder\Propagate\VersionPropagator $versionPropagator, \MonorepoBuilder20220527\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager)
    {
    ...
    protected function execute(\MonorepoBuilder20220527\Symfony\Component\Console\Input\InputInterface $input, \MonorepoBuilder20220527\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        foreach ($this->composerJsonProvider->getPackageComposerJsons() as $packageComposerJson) {
            ...
            if (!$packageFileInfo instanceof \MonorepoBuilder20220527\Symplify\SmartFileSystem\SmartFileInfo) {
