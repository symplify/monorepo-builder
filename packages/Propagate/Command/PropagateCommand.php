...
use MonorepoBuilder20211210\Symplify\Astral\Exception\ShouldNotHappenException;
...
use MonorepoBuilder20211210\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
use MonorepoBuilder20211210\Symplify\PackageBuilder\Console\Command\CommandNaming;
use MonorepoBuilder20211210\Symplify\SmartFileSystem\SmartFileInfo;
final class PropagateCommand extends \MonorepoBuilder20211210\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \Symplify\MonorepoBuilder\Propagate\VersionPropagator $versionPropagator, \MonorepoBuilder20211210\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager)
    {
    ...
    protected function execute(\MonorepoBuilder20211210\Symfony\Component\Console\Input\InputInterface $input, \MonorepoBuilder20211210\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        foreach ($this->composerJsonProvider->getPackageComposerJsons() as $packageComposerJson) {
            ...
            if (!$packageFileInfo instanceof \MonorepoBuilder20211210\Symplify\SmartFileSystem\SmartFileInfo) {
                throw new \MonorepoBuilder20211210\Symplify\Astral\Exception\ShouldNotHappenException();
            }
