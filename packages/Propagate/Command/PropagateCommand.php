...
use MonorepoBuilder20211101\Symplify\Astral\Exception\ShouldNotHappenException;
...
final class PropagateCommand extends \MonorepoBuilder20211101\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \Symplify\MonorepoBuilder\Propagate\VersionPropagator $versionPropagator, \MonorepoBuilder20211101\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager)
    {
    ...
    protected function execute($input, $output) : int
    {
        ...
        foreach ($this->composerJsonProvider->getPackageComposerJsons() as $packageComposerJson) {
            ...
            if (!$packageFileInfo instanceof \MonorepoBuilder20211101\Symplify\SmartFileSystem\SmartFileInfo) {
                throw new \MonorepoBuilder20211101\Symplify\Astral\Exception\ShouldNotHappenException();
            }
