...
use MonorepoBuilder20210703\Symplify\MonorepoBuilder\Release\Process\ProcessRunner;
final class MostRecentTagResolver
{
    ...
    public function __construct(\MonorepoBuilder20210703\Symplify\MonorepoBuilder\Release\Process\ProcessRunner $processRunner)
    {
