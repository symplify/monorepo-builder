...
final class VersionValidator
{
     ...
     * @var string[]
     */
    private const SECTIONS = [\MonorepoBuilder20220225\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE, \MonorepoBuilder20220225\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE_DEV];
    /**
    ...
    public function __construct(\MonorepoBuilder20220225\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager, \Symplify\MonorepoBuilder\Merge\Configuration\ModifyingComposerJsonProvider $modifyingComposerJsonProvider, \MonorepoBuilder20220225\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
    ...
    private function appendAppendingComposerJson(array $packageVersionsPerFile) : array
    {
        ...
        if (!$appendingComposerJson instanceof \MonorepoBuilder20220225\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson) {
