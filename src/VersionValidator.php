...
namespace MonorepoBuilder20210703\Symplify\MonorepoBuilder;

use MonorepoBuilder20210703\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager;
use MonorepoBuilder20210703\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson;
use MonorepoBuilder20210703\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection;
use MonorepoBuilder20210703\Symplify\MonorepoBuilder\Merge\Configuration\ModifyingComposerJsonProvider;
use MonorepoBuilder20210703\Symplify\MonorepoBuilder\ValueObject\File;
...
final class VersionValidator
{
     ...
     * @var string[]
     */
    private const SECTIONS = [\MonorepoBuilder20210703\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE, \MonorepoBuilder20210703\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE_DEV];
    /**
    ...
    public function __construct(\MonorepoBuilder20210703\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager, \MonorepoBuilder20210703\Symplify\MonorepoBuilder\Merge\Configuration\ModifyingComposerJsonProvider $modifyingComposerJsonProvider, \MonorepoBuilder20210703\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider)
    {
    ...
    private function appendAppendingComposerJson(array $packageVersionsPerFile) : array
    {
        ...
        if (!$appendingComposerJson instanceof \MonorepoBuilder20210703\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson) {
            return $packageVersionsPerFile;
        }
        $requires = $appendingComposerJson->getRequire();
        foreach ($requires as $packageName => $packageVersion) {
            $packageVersionsPerFile[$packageName][\MonorepoBuilder20210703\Symplify\MonorepoBuilder\ValueObject\File::CONFIG] = $packageVersion;
        }
    ...
    {
        $excludePackageVersionConflicts = $this->parameterProvider->provideArrayParameter(\MonorepoBuilder20210703\Symplify\MonorepoBuilder\ValueObject\Option::EXCLUDE_PACKAGE_VERSION_CONFLICTS);
