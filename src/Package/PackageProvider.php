...
final class PackageProvider
{
    ...
    private function detectNameFromFileInfo(\MonorepoBuilder20220512\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        if (!isset($json['name'])) {
            ...
            throw new \MonorepoBuilder20220512\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
        }
