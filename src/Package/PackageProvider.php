...
final class PackageProvider
{
    ...
    public function __construct(\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \MonorepoBuilder20220516\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager)
    {
    ...
    private function detectNameFromFileInfo(\MonorepoBuilder20220516\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        if (!isset($json['name'])) {
            ...
            throw new \MonorepoBuilder20220516\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
        }
