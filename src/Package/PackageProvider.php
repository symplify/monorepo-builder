...
final class PackageProvider
{
    ...
    public function __construct(\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \MonorepoBuilder20210928\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager)
    {
    ...
    private function detectNameFromFileInfo(\MonorepoBuilder20210928\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
