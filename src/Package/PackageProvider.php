...
final class PackageProvider
{
    ...
    public function __construct(\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \MonorepoBuilder20211208\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager)
    {
    ...
    private function detectNameFromFileInfo(\MonorepoBuilder20211208\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
