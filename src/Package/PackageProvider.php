...
final class PackageProvider
{
    ...
    public function __construct(\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \MonorepoBuilder20211127\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager)
    {
    ...
    private function detectNameFromFileInfo(\MonorepoBuilder20211127\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
