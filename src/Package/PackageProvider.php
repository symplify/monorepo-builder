...
final class PackageProvider
{
    ...
    private function detectNameFromFileInfo(\MonorepoBuilder20220511\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        if (!isset($json['name'])) {
            ...
            throw new \MonorepoBuilder20220511\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
        }
