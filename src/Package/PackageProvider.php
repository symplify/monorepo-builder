...
final class PackageProvider
{
    ...
    public function __construct(\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \MonorepoBuilder20220417\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager)
    {
    ...
    private function detectNameFromFileInfo(\MonorepoBuilder20220417\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        if (!isset($json['name'])) {
            ...
            throw new \MonorepoBuilder20220417\Symplify\SymplifyKernel\Exception\ShouldNotHappenException($errorMessage);
        }
