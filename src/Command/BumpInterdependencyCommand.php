...
final class BumpInterdependencyCommand extends \MonorepoBuilder20211120\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
     * @var string
     */
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(self::VERSION_ARGUMENT, \MonorepoBuilder20211120\Symfony\Component\Console\Input\InputArgument::REQUIRED, 'New version of inter-dependencies, e.g. "^4.4.2"');
    }
    /**
