...
final class BumpInterdependencyCommand extends \MonorepoBuilder20211207\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
     * @var string
     */
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(self::VERSION_ARGUMENT, \MonorepoBuilder20211207\Symfony\Component\Console\Input\InputArgument::REQUIRED, 'New version of inter-dependencies, e.g. "^4.4.2"');
    }
    /**
