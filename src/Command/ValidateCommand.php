...
use MonorepoBuilder20210703\Symplify\MonorepoBuilder\Validator\ConflictingPackageVersionsReporter;
use MonorepoBuilder20210703\Symplify\MonorepoBuilder\Validator\SourcesPresenceValidator;
use MonorepoBuilder20210703\Symplify\MonorepoBuilder\VersionValidator;
...
final class ValidateCommand extends \MonorepoBuilder20210703\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\MonorepoBuilder20210703\Symplify\MonorepoBuilder\FileSystem\ComposerJsonProvider $composerJsonProvider, \MonorepoBuilder20210703\Symplify\MonorepoBuilder\VersionValidator $versionValidator, \MonorepoBuilder20210703\Symplify\MonorepoBuilder\Validator\ConflictingPackageVersionsReporter $conflictingPackageVersionsReporter, \MonorepoBuilder20210703\Symplify\MonorepoBuilder\Validator\SourcesPresenceValidator $sourcesPresenceValidator)
    {
    ...
    protected function execute(\MonorepoBuilder20210703\Symfony\Component\Console\Input\InputInterface $input, \MonorepoBuilder20210703\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        return \MonorepoBuilder20210703\Symplify\PackageBuilder\Console\ShellCode::ERROR;
    }
}
