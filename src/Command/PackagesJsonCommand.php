...
final class PackagesJsonCommand extends \MonorepoBuilder20210723\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function execute($input, $output) : int
    {
        ...
        $json = \MonorepoBuilder20210723\Nette\Utils\Json::encode($packagePaths);
