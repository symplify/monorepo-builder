...
final class PackagesJsonCommand extends \MonorepoBuilder20211210\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function execute(\MonorepoBuilder20211210\Symfony\Component\Console\Input\InputInterface $input, \MonorepoBuilder20211210\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $json = \MonorepoBuilder20211210\Nette\Utils\Json::encode($allowedPackagePaths);
        echo $json;
        return self::SUCCESS;
    }
}
