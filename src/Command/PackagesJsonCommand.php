...
final class PackagesJsonCommand extends \MonorepoBuilder20211120\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function execute($input, $output) : int
    {
        ...
        $json = \MonorepoBuilder20211120\Nette\Utils\Json::encode($allowedPackagePaths);
        echo $json;
        return self::SUCCESS;
    }
}
