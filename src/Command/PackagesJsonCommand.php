...
final class PackagesJsonCommand extends \MonorepoBuilder20211012\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::TESTS, null, \MonorepoBuilder20211012\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Only with /tests directory');
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::EXCLUDE_PACKAGE, null, \MonorepoBuilder20211012\Symfony\Component\Console\Input\InputOption::VALUE_IS_ARRAY | \MonorepoBuilder20211012\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Exclude one or more package from the list, useful e.g. when scoping one package instead of bare split');
    }
    /**
    ...
    protected function execute($input, $output) : int
    {
        ...
        $json = \MonorepoBuilder20211012\Nette\Utils\Json::encode($allowedPackagePaths);
        echo $json;
        return self::SUCCESS;
    }
}
