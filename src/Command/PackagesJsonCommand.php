...
final class PackagesJsonCommand extends \MonorepoBuilder20210728\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function execute($input, $output) : int
    {
        ...
        $json = \MonorepoBuilder20210728\Nette\Utils\Json::encode($allowedPackagePaths);
        echo $json;
