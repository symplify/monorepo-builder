...
final class PackagesJsonCommand extends \MonorepoBuilder20210707\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    protected function configure() : void
    {
        ...
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::TESTS, null, \MonorepoBuilder20210707\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Only with /tests directory');
        $this->addOption(\Symplify\MonorepoBuilder\ValueObject\Option::EXCLUDE_PACKAGE, null, \MonorepoBuilder20210707\Symfony\Component\Console\Input\InputOption::VALUE_IS_ARRAY | \MonorepoBuilder20210707\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Exclude one or more package from the list, useful e.g. when scoping one package instead of bare split');
    }
    protected function execute(\MonorepoBuilder20210707\Symfony\Component\Console\Input\InputInterface $input, \MonorepoBuilder20210707\Symfony\Component\Console\Output\OutputInterface $output) : int
    {
        ...
        $json = \MonorepoBuilder20210707\Nette\Utils\Json::encode($packagePaths);
