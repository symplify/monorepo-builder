...
final class ComposerJsonProvider
{
    ...
    public function __construct(\MonorepoBuilder20211227\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager, \Symplify\MonorepoBuilder\Finder\PackageComposerFinder $packageComposerFinder, \MonorepoBuilder20211227\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory)
    {
    ...
    public function getPackageFileInfoByName(string $packageName) : \MonorepoBuilder20211227\Symplify\SmartFileSystem\SmartFileInfo
    {
        foreach ($this->getPackagesComposerFileInfos() as $packagesComposerFileInfo) {
    ...
    public function getRootComposerJson() : \MonorepoBuilder20211227\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
