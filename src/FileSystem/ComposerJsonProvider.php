...
namespace MonorepoBuilder20210703\Symplify\MonorepoBuilder\FileSystem;

use MonorepoBuilder20210703\Symplify\ComposerJsonManipulator\ComposerJsonFactory;
...
use MonorepoBuilder20210703\Symplify\MonorepoBuilder\Finder\PackageComposerFinder;
...
final class ComposerJsonProvider
{
    ...
    public function __construct(\MonorepoBuilder20210703\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager, \MonorepoBuilder20210703\Symplify\MonorepoBuilder\Finder\PackageComposerFinder $packageComposerFinder, \MonorepoBuilder20210703\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory)
    {
    ...
    public function getPackageFileInfoByName(string $packageName) : \MonorepoBuilder20210703\Symplify\SmartFileSystem\SmartFileInfo
    {
        foreach ($this->getPackagesComposerFileInfos() as $packagesComposerFileInfo) {
    ...
    public function getRootComposerJson() : \MonorepoBuilder20210703\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
        return $this->composerJsonFactory->createFromFileInfo($this->getRootFileInfo());
    }
    private function getRootFileInfo() : \MonorepoBuilder20210703\Symplify\SmartFileSystem\SmartFileInfo
    {
