...
use MonorepoBuilder20210826\Symplify\ComposerJsonManipulator\ComposerJsonFactory;
...
final class ComposerJsonProvider
{
    ...
    public function __construct(\MonorepoBuilder20210826\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager, \Symplify\MonorepoBuilder\Finder\PackageComposerFinder $packageComposerFinder, \MonorepoBuilder20210826\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory)
    {
    ...
    public function getPackageFileInfoByName(string $packageName) : \MonorepoBuilder20210826\Symplify\SmartFileSystem\SmartFileInfo
    {
        foreach ($this->getPackagesComposerFileInfos() as $packagesComposerFileInfo) {
    ...
    public function getRootComposerJson() : \MonorepoBuilder20210826\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
