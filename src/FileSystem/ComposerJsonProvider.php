...
final class ComposerJsonProvider
{
    ...
    public function __construct(\MonorepoBuilder20220307\Symplify\ComposerJsonManipulator\FileSystem\JsonFileManager $jsonFileManager, \Symplify\MonorepoBuilder\Finder\PackageComposerFinder $packageComposerFinder, \MonorepoBuilder20220307\Symplify\ComposerJsonManipulator\ComposerJsonFactory $composerJsonFactory)
    {
    ...
    public function getPackageFileInfoByName(string $packageName) : \MonorepoBuilder20220307\Symplify\SmartFileSystem\SmartFileInfo
    {
        foreach ($this->getPackagesComposerFileInfos() as $packagesComposerFileInfo) {
    ...
    public function getRootComposerJson() : \MonorepoBuilder20220307\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson
    {
