...
final class VersionUtils
{
    ...
    public function __construct(\MonorepoBuilder20210818\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Symplify\MonorepoBuilder\ValueObjectFactory\VersionFactory $versionFactory)
    {
