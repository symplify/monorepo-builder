...
final class VersionUtils
{
    ...
    public function __construct(\MonorepoBuilder20210728\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \Symplify\MonorepoBuilder\ValueObjectFactory\VersionFactory $versionFactory)
    {
