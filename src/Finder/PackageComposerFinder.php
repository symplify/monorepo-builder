...
final class PackageComposerFinder
{
    ...
    public function __construct(\MonorepoBuilder20211212\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \MonorepoBuilder20211212\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer)
    {
    ...
    public function getRootPackageComposerFile() : \MonorepoBuilder20211212\Symplify\SmartFileSystem\SmartFileInfo
    {
        return new \MonorepoBuilder20211212\Symplify\SmartFileSystem\SmartFileInfo(\getcwd() . \DIRECTORY_SEPARATOR . 'composer.json');
    }
    /**
