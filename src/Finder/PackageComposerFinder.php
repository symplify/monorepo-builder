...
final class PackageComposerFinder
{
    ...
    public function __construct(\MonorepoBuilder20220121\Symplify\PackageBuilder\Parameter\ParameterProvider $parameterProvider, \MonorepoBuilder20220121\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer)
    {
    ...
    public function getRootPackageComposerFile() : \MonorepoBuilder20220121\Symplify\SmartFileSystem\SmartFileInfo
    {
        return new \MonorepoBuilder20220121\Symplify\SmartFileSystem\SmartFileInfo(\getcwd() . \DIRECTORY_SEPARATOR . 'composer.json');
    }
    /**
    ...
    public function getPackageComposerFiles() : array
    {
        ...
        if ($this->cachedPackageComposerFiles === []) {
            $finder = \MonorepoBuilder20220121\Symfony\Component\Finder\Finder::create()->files()->in($this->packageDirectories)->exclude('compiler')->exclude('templates')->exclude('vendor')->exclude('build')->exclude('node_modules')->name('composer.json');
