...
final class MBConfig extends \Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator
{
    ...
    {
        \MonorepoBuilder20220605\Webmozart\Assert\Assert::allString($packageDirectories);
        \MonorepoBuilder20220605\Webmozart\Assert\Assert::allFileExists($packageDirectories);
    ...
    {
        \MonorepoBuilder20220605\Webmozart\Assert\Assert::allString(\array_keys($dataToRemove));
        $parameters = $this->parameters();
    ...
    {
        \MonorepoBuilder20220605\Webmozart\Assert\Assert::allString(\array_keys($dataToAppend));
        $parameters = $this->parameters();
    ...
    {
        \MonorepoBuilder20220605\Webmozart\Assert\Assert::allString($workerClasses);
        \MonorepoBuilder20220605\Webmozart\Assert\Assert::allIsAOf($workerClasses, \Symplify\MonorepoBuilder\Release\Contract\ReleaseWorker\ReleaseWorkerInterface::class);
    ...
    {
        \MonorepoBuilder20220605\Webmozart\Assert\Assert::allString($sectionOrder);
        $parameters = $this->parameters();
    ...
    {
        \MonorepoBuilder20220605\Webmozart\Assert\Assert::allString($inlineSections);
        $parameters = $this->parameters();
