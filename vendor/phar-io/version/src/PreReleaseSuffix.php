...
class PreReleaseSuffix
{
    ...
    public function isGreaterThan(\MonorepoBuilder20210705\PharIo\Version\PreReleaseSuffix $suffix) : bool
    {
    ...
    private function parseValue(string $value) : void
    {
        ...
        if (\preg_match($regex, $value, $matches) !== 1) {
            throw new \MonorepoBuilder20210705\PharIo\Version\InvalidPreReleaseSuffixException(\sprintf('Invalid label %s', $value));
        }
        $this->full = $matches[1];
