...
class NormalizationBuilder
{
    ...
    public $before = [];
    public $remappings = [];
    public function __construct(\MonorepoBuilder20211130\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    public function before($closure = null)
    {
        ...
        return $this->before[] = new \MonorepoBuilder20211130\Symfony\Component\Config\Definition\Builder\ExprBuilder($this->node);
    }
}
