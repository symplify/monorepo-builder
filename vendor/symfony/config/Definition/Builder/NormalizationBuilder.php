...
class NormalizationBuilder
{
    ...
    public $before = [];
    public $remappings = [];
    public function __construct(\MonorepoBuilder20220607\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    public function before(\Closure $closure = null)
    {
        ...
        return $this->before[] = new \MonorepoBuilder20220607\Symfony\Component\Config\Definition\Builder\ExprBuilder($this->node);
    }
}
