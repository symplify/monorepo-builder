...
class ExprBuilder
{
    ...
    public $ifPart;
    public $thenPart;
    public function __construct(\MonorepoBuilder20220207\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    {
        $this->thenPart = function () {
            throw new \MonorepoBuilder20220207\Symfony\Component\Config\Definition\Exception\UnsetKeyException('Unsetting key.');
        };
        return $this;
    }
    /**
