 ...
 */
class ResourceCheckerConfigCache implements \MonorepoBuilder20211114\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \MonorepoBuilder20211114\Symfony\Component\Filesystem\Filesystem();
