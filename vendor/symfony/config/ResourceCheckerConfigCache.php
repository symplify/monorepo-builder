 ...
 */
class ResourceCheckerConfigCache implements \MonorepoBuilder20220120\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \MonorepoBuilder20220120\Symfony\Component\Filesystem\Filesystem();
