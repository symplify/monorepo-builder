 ...
 */
namespace MonorepoBuilderPrefix202408\Symfony\Component\Config\Builder;
...
use MonorepoBuilderPrefix202408\Symfony\Component\Config\Definition\Builder\ExprBuilder;
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('MonorepoBuilderPrefix202408\\Symfony\\Config', $rootNode->getName());
