 ...
 */
namespace MonorepoBuilder20220609\Symfony\Component\Config\Builder;

use MonorepoBuilder20220609\Symfony\Component\Config\Definition\ArrayNode;
use MonorepoBuilder20220609\Symfony\Component\Config\Definition\BooleanNode;
...
use MonorepoBuilder20220609\Symfony\Component\Config\Definition\FloatNode;
use MonorepoBuilder20220609\Symfony\Component\Config\Definition\IntegerNode;
...
use MonorepoBuilder20220609\Symfony\Component\Config\Definition\ScalarNode;
use MonorepoBuilder20220609\Symfony\Component\Config\Definition\VariableNode;
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('MonorepoBuilder20220609\\Symfony\\Config', $rootNode->getName());
