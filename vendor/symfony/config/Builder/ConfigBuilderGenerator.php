...
use MonorepoBuilderPrefix202311\Symfony\Component\Config\Definition\Builder\ExprBuilder;
...
class ConfigBuilderGenerator implements ConfigBuilderGeneratorInterface
{
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new ClassBuilder('MonorepoBuilderPrefix202311\\Symfony\\Config', $rootNode->getName());
