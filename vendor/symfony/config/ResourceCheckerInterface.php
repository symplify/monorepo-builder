...
interface ResourceCheckerInterface
{
     ...
     * @return bool
     */
    public function supports(\MonorepoBuilder20220523\Symfony\Component\Config\Resource\ResourceInterface $metadata);
    /**
     ...
     * @return bool
     */
    public function isFresh(\MonorepoBuilder20220523\Symfony\Component\Config\Resource\ResourceInterface $resource, int $timestamp);
}
