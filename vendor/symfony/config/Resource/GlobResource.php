...
use MonorepoBuilder20211211\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \MonorepoBuilder20211211\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    /**
     * @var string
     */
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\MonorepoBuilder20211211\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \MonorepoBuilder20211211\Symfony\Component\Finder\Finder();
        $regex = \MonorepoBuilder20211211\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
