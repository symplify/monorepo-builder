...
use MonorepoBuilder20220531\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \MonorepoBuilder20220531\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    /**
     * @var string
     */
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\MonorepoBuilder20220531\Symfony\Component\Finder\Finder::class)) {
        ...
        $regex = \MonorepoBuilder20220531\Symfony\Component\Finder\Glob::toRegex($pattern);
        if ($this->recursive) {
