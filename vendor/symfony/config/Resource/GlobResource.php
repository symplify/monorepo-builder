 ...
 * @final
 */
class GlobResource implements \IteratorAggregate, \MonorepoBuilder20210707\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\MonorepoBuilder20210707\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \MonorepoBuilder20210707\Symfony\Component\Finder\Finder();
        $regex = \MonorepoBuilder20210707\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
