 ...
 */
namespace MonorepoBuilder20220417\Symfony\Component\Config\Resource;

use MonorepoBuilder20220417\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use MonorepoBuilder20220417\Symfony\Component\Messenger\Handler\MessageSubscriberInterface;
 ...
 * @final
 */
class ReflectionClassResource implements \MonorepoBuilder20220417\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    /**
     * @var mixed[]
     */
    ...
    private function generateSignature(\ReflectionClass $class) : iterable
    {
        ...
        if (\interface_exists(\MonorepoBuilder20220417\Symfony\Component\EventDispatcher\EventSubscriberInterface::class, \false) && $class->isSubclassOf(\MonorepoBuilder20220417\Symfony\Component\EventDispatcher\EventSubscriberInterface::class)) {
            (yield \MonorepoBuilder20220417\Symfony\Component\EventDispatcher\EventSubscriberInterface::class);
            (yield \print_r($class->name::getSubscribedEvents(), \true));
        }
        if (\interface_exists(\MonorepoBuilder20220417\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class, \false) && $class->isSubclassOf(\MonorepoBuilder20220417\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class)) {
            (yield \MonorepoBuilder20220417\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class);
            foreach ($class->name::getHandledMessages() as $key => $value) {
                (yield $key . \print_r($value, \true));
            }
        }
        if (\interface_exists(\MonorepoBuilder20220417\Symfony\Contracts\Service\ServiceSubscriberInterface::class, \false) && $class->isSubclassOf(\MonorepoBuilder20220417\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
            (yield \MonorepoBuilder20220417\Symfony\Contracts\Service\ServiceSubscriberInterface::class);
