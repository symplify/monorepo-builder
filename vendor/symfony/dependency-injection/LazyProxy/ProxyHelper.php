 ...
 */
namespace MonorepoBuilder20211231\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint(\ReflectionFunctionAbstract $r, \ReflectionParameter $p = null, bool $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \MonorepoBuilder20211231\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
