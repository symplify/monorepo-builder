 ...
 */
namespace MonorepoBuilder20211216\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint(\ReflectionFunctionAbstract $r, \ReflectionParameter $p = null, bool $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \MonorepoBuilder20211216\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
