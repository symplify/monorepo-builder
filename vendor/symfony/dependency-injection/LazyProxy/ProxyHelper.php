 ...
 */
namespace MonorepoBuilder20211219\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint(\ReflectionFunctionAbstract $r, \ReflectionParameter $p = null, bool $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \MonorepoBuilder20211219\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
