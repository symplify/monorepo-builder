 ...
 */
namespace MonorepoBuilder20220116\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint(\ReflectionFunctionAbstract $r, \ReflectionParameter $p = null, bool $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \MonorepoBuilder20220116\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
