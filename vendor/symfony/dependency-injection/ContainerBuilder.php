...
use MonorepoBuilder20220609\Composer\InstalledVersions;
use MonorepoBuilder20220609\Symfony\Component\Config\Resource\ClassExistenceResource;
use MonorepoBuilder20220609\Symfony\Component\Config\Resource\ComposerResource;
use MonorepoBuilder20220609\Symfony\Component\Config\Resource\DirectoryResource;
use MonorepoBuilder20220609\Symfony\Component\Config\Resource\FileExistenceResource;
use MonorepoBuilder20220609\Symfony\Component\Config\Resource\FileResource;
use MonorepoBuilder20220609\Symfony\Component\Config\Resource\GlobResource;
use MonorepoBuilder20220609\Symfony\Component\Config\Resource\ReflectionClassResource;
...
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\Attribute\Target;
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\Compiler\Compiler;
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\Exception\BadMethodCallException;
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\Exception\LogicException;
...
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag;
use MonorepoBuilder20220609\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;
...
use MonorepoBuilder20220609\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
/**
    ...
    */
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (!isset($this->expressionLanguage)) {
            if (!\class_exists(\MonorepoBuilder20220609\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
