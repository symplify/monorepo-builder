    ...
    public function setDeprecated()
    {
        ...
        if ('' !== $message) {
            ...
            if (\false === \strpos($message, '%alias_id%')) {
                throw new \MonorepoBuilder20210708\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException('The deprecation template must contain the "%alias_id%" placeholder.');
            }
        }
