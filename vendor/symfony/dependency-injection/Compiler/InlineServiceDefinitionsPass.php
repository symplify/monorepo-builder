 ...
 */
class InlineServiceDefinitionsPass extends \MonorepoBuilder20220109\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    private $graph = null;
    public function __construct(\MonorepoBuilder20220109\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass $analyzingPass = null)
    {
    ...
    public function process(\MonorepoBuilder20220109\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        if ($this->analyzingPass) {
            $analyzedContainer = new \MonorepoBuilder20220109\Symfony\Component\DependencyInjection\ContainerBuilder();
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        if ($value instanceof \MonorepoBuilder20220109\Symfony\Component\DependencyInjection\Definition && $this->cloningIds) {
            if ($value->isShared()) {
                return $value;
            }
            $value = clone $value;
        ...
        if (isset($this->cloningIds[$id])) {
            ...
            $ids[] = $id;
            throw new \MonorepoBuilder20220109\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_slice($ids, \array_search($id, $ids)));
        }
     ...
     */
    private function isInlineableDefinition(string $id, \MonorepoBuilder20220109\Symfony\Component\DependencyInjection\Definition $definition) : bool
    {
        ...
        if ($srcCount > 1 && \is_array($factory = $definition->getFactory()) && ($factory[0] instanceof \MonorepoBuilder20220109\Symfony\Component\DependencyInjection\Reference || $factory[0] instanceof \MonorepoBuilder20220109\Symfony\Component\DependencyInjection\Definition)) {
            return \false;
        }
