 ...
 */
class AutowireRequiredMethodsPass extends \MonorepoBuilder20220416\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     * @param mixed $value
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\method_exists($r, 'getAttributes') ? $r->getAttributes(\MonorepoBuilder20220416\Symfony\Contracts\Service\Attribute\Required::class) : []) {
