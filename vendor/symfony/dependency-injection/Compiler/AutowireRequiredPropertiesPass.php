 ...
 */
class AutowireRequiredPropertiesPass extends \MonorepoBuilder20210710\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     * @param bool $isRoot
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getProperties() as $reflectionProperty) {
            ...
            if ((\PHP_VERSION_ID < 80000 || !$reflectionProperty->getAttributes(\MonorepoBuilder20210710\Symfony\Contracts\Service\Attribute\Required::class)) && (\false === ($doc = $reflectionProperty->getDocComment()) || \false === \stripos($doc, '@required') || !\preg_match('#(?:^/\\*\\*|\\n\\s*+\\*)\\s*+@required(?:\\s|\\*/$)#i', $doc))) {
                continue;
            }
            ...
            $type = $type->getName();
            $value->setProperty($name, new \MonorepoBuilder20210710\Symfony\Component\DependencyInjection\TypedReference($type, $type, \MonorepoBuilder20210710\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, $name));
        }
        return $value;
    }
}
