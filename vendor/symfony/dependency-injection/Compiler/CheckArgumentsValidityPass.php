 ...
 */
class CheckArgumentsValidityPass extends \MonorepoBuilder20220117\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * @var bool
     */
            ...
            if ($k !== $i++) {
                if (!\is_int($k)) {
                    ...
                    if ($this->throwExceptions) {
                        throw new \MonorepoBuilder20220117\Symfony\Component\DependencyInjection\Exception\RuntimeException($msg);
                    }
                    break;
                }
