 ...
 */
class CheckArgumentsValidityPass extends \MonorepoBuilder20211031\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
            ...
            if ($k !== $i++) {
                if (!\is_int($k)) {
                    ...
                    if ($this->throwExceptions) {
                        throw new \MonorepoBuilder20211031\Symfony\Component\DependencyInjection\Exception\RuntimeException($msg);
                    }
                    break;
                }
