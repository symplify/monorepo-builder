 ...
 */
class ResolveClassPass implements \MonorepoBuilder20210909\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * {@inheritdoc}
    ...
    public function process($container)
    {
        foreach ($container->getDefinitions() as $id => $definition) {
            ...
            if (\preg_match('/^[a-zA-Z_\\x7f-\\xff][a-zA-Z0-9_\\x7f-\\xff]*+(?:\\\\[a-zA-Z_\\x7f-\\xff][a-zA-Z0-9_\\x7f-\\xff]*+)++$/', $id)) {
                if ($definition instanceof \MonorepoBuilder20210909\Symfony\Component\DependencyInjection\ChildDefinition && !\class_exists($id)) {
