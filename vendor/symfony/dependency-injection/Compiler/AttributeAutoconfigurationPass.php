 ...
 */
final class AttributeAutoconfigurationPass extends \MonorepoBuilder20220601\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    public function process(\MonorepoBuilder20220601\Symfony\Component\DependencyInjection\ContainerBuilder $container) : void
    {
    ...
    {
        if (!$value instanceof \MonorepoBuilder20220601\Symfony\Component\DependencyInjection\Definition || !$value->isAutoconfigured() || $value->isAbstract() || $value->hasTag('container.ignore_attributes') || !($classReflector = $this->container->getReflectionClass($value->getClass(), \false))) {
            return parent::processValue($value, $isRoot);
        }
        $instanceof = $value->getInstanceofConditionals();
        $conditionals = $instanceof[$classReflector->getName()] ?? new \MonorepoBuilder20220601\Symfony\Component\DependencyInjection\ChildDefinition('');
        ...
        if (!isset($instanceof[$classReflector->getName()]) && new \MonorepoBuilder20220601\Symfony\Component\DependencyInjection\ChildDefinition('') != $conditionals) {
