 ...
 */
namespace MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Dumper;

use MonorepoBuilder20220611\Composer\Autoload\ClassLoader;
use MonorepoBuilder20220611\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Argument\AbstractArgument;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Argument\ArgumentInterface;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Compiler\CheckCircularReferencesPass;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Container;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\ContainerBuilder;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\ContainerInterface;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Definition;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Exception\LogicException;
...
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\ExpressionLanguage;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Loader\FileLoader;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Parameter;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Reference;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\ServiceLocator as BaseServiceLocator;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\TypedReference;
use MonorepoBuilder20220611\Symfony\Component\DependencyInjection\Variable;
use MonorepoBuilder20220611\Symfony\Component\ErrorHandler\DebugClassLoader;
use MonorepoBuilder20220611\Symfony\Component\ExpressionLanguage\Expression;
use MonorepoBuilder20220611\Symfony\Component\HttpKernel\Kernel;
/**
...
use MonorepoBuilder20220611\\Symfony\\Component\\DependencyInjection\\Argument\\RewindableGenerator;
use MonorepoBuilder20220611\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
...
use MonorepoBuilder20220611\\Symfony\\Component\\DependencyInjection\\Dumper\\Preloader;
...
use MonorepoBuilder20220611\\Symfony\\Component\\DependencyInjection\\Exception\\LogicException;
use MonorepoBuilder20220611\\Symfony\\Component\\DependencyInjection\\Exception\\RuntimeException;
use MonorepoBuilder20220611\\Symfony\\Component\\DependencyInjection\\ParameterBag\\FrozenParameterBag;
use MonorepoBuilder20220611\\Symfony\\Component\\DependencyInjection\\ParameterBag\\ParameterBagInterface;
...
EOF;
    ...
    private function getExpressionLanguage() : ExpressionLanguage
    {
        if (!isset($this->expressionLanguage)) {
            if (!\class_exists(\MonorepoBuilder20220611\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
