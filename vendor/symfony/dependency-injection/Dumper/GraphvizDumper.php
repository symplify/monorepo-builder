...
use MonorepoBuilder20210726\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException;
 ...
 */
class GraphvizDumper extends \MonorepoBuilder20210726\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    private $nodes;
    private $edges;
    ...
    private function findEdges(string $id, array $arguments, bool $required, string $name, bool $lazy = \false) : array
    {
        ...
        foreach ($arguments as $argument) {
            if ($argument instanceof \MonorepoBuilder20210726\Symfony\Component\DependencyInjection\Parameter) {
            ...
            } elseif ($argument instanceof \MonorepoBuilder20210726\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
    ...
    private function findNodes() : array
    {
        ...
        foreach ($container->getDefinitions() as $id => $definition) {
            ...
            } catch (\MonorepoBuilder20210726\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException $e) {
            }
            ...
            $container->setDefinition($id, new \MonorepoBuilder20210726\Symfony\Component\DependencyInjection\Definition('stdClass'));
        }
    ...
    private function cloneContainer() : \MonorepoBuilder20210726\Symfony\Component\DependencyInjection\ContainerBuilder
    {
        $parameterBag = new \MonorepoBuilder20210726\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->container->getParameterBag()->all());
        $container = new \MonorepoBuilder20210726\Symfony\Component\DependencyInjection\ContainerBuilder($parameterBag);
