 ...
 */
class HtmlErrorRenderer implements \MonorepoBuilder20211014\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface
{
     ...
     */
    public function __construct($debug = \false, string $charset = null, $fileLinkFormat = null, string $projectDir = null, $outputBuffer = '', \MonorepoBuilder20211014\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    public function render($exception) : \MonorepoBuilder20211014\Symfony\Component\ErrorHandler\Exception\FlattenException
    {
        ...
        $exception = \MonorepoBuilder20211014\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception, null, $headers);
    ...
    public static function getAndCleanOutputBuffer($requestStack) : \Closure
    {
        return static function () use($requestStack) : string {
            ...
            \MonorepoBuilder20211014\Symfony\Component\HttpFoundation\Response::closeOutputBuffers($startObLevel + 1, \true);
            return \ob_get_clean();
        };
    }
    private function renderException(\MonorepoBuilder20211014\Symfony\Component\ErrorHandler\Exception\FlattenException $exception, string $debugTemplate = 'views/exception_full.html.php') : string
    {
