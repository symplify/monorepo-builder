...
use MonorepoBuilder20211007\Symfony\Component\ErrorHandler\Error\UndefinedMethodError;
/**
 * @author Grégoire Pineau <lyrixx@lyrixx.info>
 */
class UndefinedMethodErrorEnhancer implements \MonorepoBuilder20211007\Symfony\Component\ErrorHandler\ErrorEnhancer\ErrorEnhancerInterface
{
    /**
     * {@inheritdoc}
    ...
    public function enhance($error) : ?\Throwable
    {
        ...
        if ('' === $methodName || !\class_exists($className) || null === ($methods = \get_class_methods($className))) {
            ...
            return new \MonorepoBuilder20211007\Symfony\Component\ErrorHandler\Error\UndefinedMethodError($message, $error);
        }
        $candidates = [];
