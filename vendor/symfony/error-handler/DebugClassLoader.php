...
use MonorepoBuilder20210930\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use MonorepoBuilder20210930\Doctrine\Persistence\Proxy;
use MonorepoBuilder20210930\Mockery\MockInterface;
use MonorepoBuilder20210930\Phake\IMock;
use MonorepoBuilder20210930\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use MonorepoBuilder20210930\PHPUnit\Framework\MockObject\MockObject;
use MonorepoBuilder20210930\Prophecy\Prophecy\ProphecySubjectInterface;
use MonorepoBuilder20210930\ProxyManager\Proxy\ProxyInterface;
/**
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\MonorepoBuilder20210930\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\MonorepoBuilder20210930\Psr\Log\LogLevel::class);
    ...
    public function checkAnnotations($refl, $class) : array
    {
        ...
        foreach ($parentAndOwnInterfaces + \class_uses($class, \false) as $use) {
            ...
            if (isset(self::$method[$use])) {
                if ($refl->isAbstract()) {
                    ...
                    if (!\strncmp($vendor, \str_replace('_', '\\', $use), $vendorLen) && 0 === \strpos($className, 'Symfony\\') && (!\class_exists(\MonorepoBuilder20210930\Composer\InstalledVersions::class) || 'symfony/symfony' !== \MonorepoBuilder20210930\Composer\InstalledVersions::getRootPackage()['name'])) {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \MonorepoBuilder20210930\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
