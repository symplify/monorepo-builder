...
?></style>
    ...
    <body>
        ...
        <?php 
if (\class_exists(\MonorepoBuilder20210805\Symfony\Component\HttpKernel\Kernel::class)) {
    ?>
            <header>
                <div class="container">
                    <h1 class="logo"><?php 
    ...
    echo \MonorepoBuilder20210805\Symfony\Component\HttpKernel\Kernel::VERSION;
    ?>/index.html">
                            <span class="icon"><?php 
