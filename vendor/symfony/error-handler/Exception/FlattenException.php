 ...
 */
namespace MonorepoBuilder20210927\Symfony\Component\ErrorHandler\Exception;
...
class FlattenException
{
    ...
    public static function createFromThrowable($exception, $statusCode = null, $headers = []) : self
    {
        ...
        if ($exception instanceof \MonorepoBuilder20210927\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \MonorepoBuilder20210927\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        }
        if (\class_exists(\MonorepoBuilder20210927\Symfony\Component\HttpFoundation\Response::class) && isset(\MonorepoBuilder20210927\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode])) {
            $statusText = \MonorepoBuilder20210927\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode];
        } else {
