 ...
 */
namespace MonorepoBuilderPrefix202308\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTestCase extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\MonorepoBuilderPrefix202308\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\MonorepoBuilderPrefix202308\Psr\Container\ContainerExceptionInterface::class);
