 ...
 */
namespace MonorepoBuilder202211\Symfony\Contracts\Service\Test;

use MonorepoBuilder202211\PHPUnit\Framework\TestCase;
use MonorepoBuilder202211\Psr\Container\ContainerInterface;
use MonorepoBuilder202211\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\MonorepoBuilder202211\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\MonorepoBuilder202211\Psr\Container\ContainerExceptionInterface::class);
