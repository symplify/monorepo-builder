 ...
 */
namespace MonorepoBuilder20211210\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends \MonorepoBuilder20211210\PHPUnit\Framework\TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\MonorepoBuilder20211210\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\MonorepoBuilder20211210\Psr\Container\ContainerExceptionInterface::class);
