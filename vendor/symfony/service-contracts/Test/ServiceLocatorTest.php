 ...
 */
namespace MonorepoBuilder202206\Symfony\Contracts\Service\Test;

use MonorepoBuilder202206\PHPUnit\Framework\TestCase;
use MonorepoBuilder202206\Psr\Container\ContainerInterface;
use MonorepoBuilder202206\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\MonorepoBuilder202206\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\MonorepoBuilder202206\Psr\Container\ContainerExceptionInterface::class);
