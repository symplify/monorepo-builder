 ...
 */
namespace MonorepoBuilderPrefix202301\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\MonorepoBuilderPrefix202301\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\MonorepoBuilderPrefix202301\Psr\Container\ContainerExceptionInterface::class);
