 ...
 */
namespace MonorepoBuilder202210\Symfony\Contracts\Service\Test;

use MonorepoBuilder202210\PHPUnit\Framework\TestCase;
use MonorepoBuilder202210\Psr\Container\ContainerInterface;
use MonorepoBuilder202210\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\MonorepoBuilder202210\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\MonorepoBuilder202210\Psr\Container\ContainerExceptionInterface::class);
