 ...
 */
namespace MonorepoBuilder20220609\Symfony\Contracts\Service\Test;

use MonorepoBuilder20220609\PHPUnit\Framework\TestCase;
use MonorepoBuilder20220609\Psr\Container\ContainerInterface;
use MonorepoBuilder20220609\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\MonorepoBuilder20220609\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\MonorepoBuilder20220609\Psr\Container\ContainerExceptionInterface::class);
