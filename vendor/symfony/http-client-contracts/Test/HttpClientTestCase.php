 ...
 */
namespace MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Test;

use MonorepoBuilder20211023\PHPUnit\Framework\TestCase;
use MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface;
use MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface;
use MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface;
use MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface;
 ...
 */
abstract class HttpClientTestCase extends \MonorepoBuilder20211023\PHPUnit\Framework\TestCase
{
    public static function setUpBeforeClass() : void
    {
        \MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Test\TestHttpServer::start();
    }
    /**
     * @param string $testCase
     */
    protected abstract function getHttpClient($testCase) : \MonorepoBuilder20211023\Symfony\Contracts\HttpClient\HttpClientInterface;
    public function testGetRequest()
    {
        ...
        $this->expectException(\MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class);
        $response->getContent();
    }
    ...
    public function testClientError()
    {
        ...
        try {
            $response->getHeaders();
            $this->fail(\MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface::class . ' expected');
        } catch (\MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface $e) {
        }
        try {
            $response->getContent();
            $this->fail(\MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\ClientExceptionInterface::class . ' expected');
    ...
    public function testDnsError()
    {
        ...
        try {
            ...
            $this->fail(\MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class . ' expected');
        } catch (\MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface $e) {
            $this->addToAssertionCount(1);
        }
        try {
            $response->getStatusCode();
            $this->fail(\MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface::class . ' still expected');
        } catch (\MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\TransportExceptionInterface $e) {
            $this->addToAssertionCount(1);
        }
        $response = $client->request('GET', 'http://localhost:8057/301/bad-tld');
    ...
    public function testInvalidRedirect()
    {
        ...
        $this->assertNull($response->getInfo('redirect_url'));
        $this->expectException(\MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface::class);
        $response->getHeaders();
    }
    ...
    public function testMaxRedirects()
    {
        ...
        try {
            $response->getHeaders();
            $this->fail(\MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface::class . ' expected');
        } catch (\MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\RedirectionExceptionInterface $e) {
        }
        $this->assertSame(302, $response->getStatusCode());
    ...
    public function testTimeoutIsNotAFatalError()
    {
        ...
        try {
            $response->getContent();
            $this->fail(\MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface::class . ' expected');
        } catch (\MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Exception\TimeoutExceptionInterface $e) {
        }
        for ($i = 0; $i < 10; ++$i) {
            try {
    ...
    {
        $p1 = \MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8067);
        $p2 = \MonorepoBuilder20211023\Symfony\Contracts\HttpClient\Test\TestHttpServer::start(8077);
        $client = $this->getHttpClient(__FUNCTION__);
