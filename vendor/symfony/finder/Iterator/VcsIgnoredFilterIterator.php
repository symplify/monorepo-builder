...
use MonorepoBuilder20211203\Symfony\Component\Finder\Gitignore;
final class VcsIgnoredFilterIterator extends \FilterIterator
{
    ...
    private function readGitignoreFile(string $path) : ?array
    {
        ...
        return $this->gitignoreFilesCache[$path] = [\MonorepoBuilder20211203\Symfony\Component\Finder\Gitignore::toRegex($gitignoreFileContent), \MonorepoBuilder20211203\Symfony\Component\Finder\Gitignore::toRegexMatchingNegatedPatterns($gitignoreFileContent)];
    }
