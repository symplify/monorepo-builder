...
use MonorepoBuilder20220316\Symfony\Component\Finder\Gitignore;
final class VcsIgnoredFilterIterator extends \FilterIterator
{
    ...
    private function readGitignoreFile(string $path) : ?array
    {
        ...
        return $this->gitignoreFilesCache[$path] = [\MonorepoBuilder20220316\Symfony\Component\Finder\Gitignore::toRegex($gitignoreFileContent), \MonorepoBuilder20220316\Symfony\Component\Finder\Gitignore::toRegexMatchingNegatedPatterns($gitignoreFileContent)];
    }
