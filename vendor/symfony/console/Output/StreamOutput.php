 ...
 */
class StreamOutput extends \MonorepoBuilder20210707\Symfony\Component\Console\Output\Output
{
    private $stream;
    /**
     ...
     */
    public function __construct($stream, int $verbosity = self::VERBOSITY_NORMAL, bool $decorated = null, \MonorepoBuilder20210707\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter = null)
    {
        if (!\is_resource($stream) || 'stream' !== \get_resource_type($stream)) {
            throw new \MonorepoBuilder20210707\Symfony\Component\Console\Exception\InvalidArgumentException('The StreamOutput class needs a stream as its first argument.');
        }
        $this->stream = $stream;
        if (null === $decorated) {
