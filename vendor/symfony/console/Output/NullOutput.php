...
use MonorepoBuilder20220503\Symfony\Component\Console\Formatter\NullOutputFormatter;
 ...
 */
class NullOutput implements \MonorepoBuilder20220503\Symfony\Component\Console\Output\OutputInterface
{
    private $formatter;
    /**
     * {@inheritdoc}
    ...
    public function getFormatter() : \MonorepoBuilder20220503\Symfony\Component\Console\Formatter\OutputFormatterInterface
    {
        ...
        return $this->formatter = $this->formatter ?? new \MonorepoBuilder20220503\Symfony\Component\Console\Formatter\NullOutputFormatter();
    }
    /**
     * {@inheritdoc}
     */
