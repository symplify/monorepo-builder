 ...
 * @internal
 */
class XmlDescriptor extends \MonorepoBuilder20211008\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
    ...
    public function getApplicationDocument($application, $namespace = null, $short = \false) : \DOMDocument
    {
        ...
        $description = new \MonorepoBuilder20211008\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
    ...
    private function getInputArgumentDocument(\MonorepoBuilder20211008\Symfony\Component\Console\Input\InputArgument $argument) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    private function getInputOptionDocument(\MonorepoBuilder20211008\Symfony\Component\Console\Input\InputOption $option) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
