 ...
 * @internal
 */
class JsonDescriptor extends \MonorepoBuilder20210911\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
    ...
    protected function describeApplication($application, $options = [])
    {
        ...
        $description = new \MonorepoBuilder20210911\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
    ...
    private function getInputArgumentData(\MonorepoBuilder20210911\Symfony\Component\Console\Input\InputArgument $argument) : array
    {
    ...
    private function getInputOptionData(\MonorepoBuilder20210911\Symfony\Component\Console\Input\InputOption $option, bool $negated = \false) : array
    {
    ...
    private function getInputDefinitionData(\MonorepoBuilder20210911\Symfony\Component\Console\Input\InputDefinition $definition) : array
    {
        $inputArguments = [];
    ...
    private function getCommandData(\MonorepoBuilder20210911\Symfony\Component\Console\Command\Command $command, bool $short = \false) : array
    {
