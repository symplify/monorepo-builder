 ...
 */
abstract class Helper implements \MonorepoBuilder20220607\Symfony\Component\Console\Helper\HelperInterface
{
    ...
    public static function width(?string $string) : int
    {
        ...
        if (\preg_match('//u', $string)) {
            return (new \MonorepoBuilder20220607\Symfony\Component\String\UnicodeString($string))->width(\false);
        }
    ...
    public static function length(?string $string) : int
    {
        $string ?? ($string = '');
        if (\preg_match('//u', $string)) {
            return (new \MonorepoBuilder20220607\Symfony\Component\String\UnicodeString($string))->length();
        }
        if (\false === ($encoding = \mb_detect_encoding($string, null, \true))) {
            return \strlen($string);
        }
    ...
    public static function removeDecoration(\MonorepoBuilder20220607\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter, ?string $string)
    {
