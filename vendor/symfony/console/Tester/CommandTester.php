...
class CommandTester
{
    ...
    private $input;
    private $statusCode;
    public function __construct(\MonorepoBuilder20210710\Symfony\Component\Console\Command\Command $command)
    {
    ...
    public function execute($input, $options = [])
    {
        ...
        $this->input = new \MonorepoBuilder20210710\Symfony\Component\Console\Input\ArrayInput($input);
