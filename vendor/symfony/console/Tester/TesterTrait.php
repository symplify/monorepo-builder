...
trait TesterTrait
{
    ...
    private function initOutput(array $options)
    {
        ...
        if (!$this->captureStreamsIndependently) {
            $this->output = new \MonorepoBuilder20210710\Symfony\Component\Console\Output\StreamOutput(\fopen('php://memory', 'w', \false));
            ...
            $this->output = new \MonorepoBuilder20210710\Symfony\Component\Console\Output\ConsoleOutput($options['verbosity'] ?? \MonorepoBuilder20210710\Symfony\Component\Console\Output\ConsoleOutput::VERBOSITY_NORMAL, $options['decorated'] ?? null);
            $errorOutput = new \MonorepoBuilder20210710\Symfony\Component\Console\Output\StreamOutput(\fopen('php://memory', 'w', \false));
