 ...
 */
class StringInput extends \MonorepoBuilder20210706\Symfony\Component\Console\Input\ArgvInput
{
    ...
    private function tokenize(string $input) : array
    {
        ...
        while ($cursor < $length) {
            if (\preg_match('/\\s+/A', $input, $match, 0, $cursor)) {
                ...
                // should never happen
                throw new \MonorepoBuilder20210706\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('Unable to parse input near "... %s ...".', \substr($input, $cursor, 10)));
            }
