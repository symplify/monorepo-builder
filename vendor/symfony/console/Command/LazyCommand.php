 ...
 */
final class LazyCommand extends \MonorepoBuilder20211223\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * @var bool|null
    ...
    public function setApplication(\MonorepoBuilder20211223\Symfony\Component\Console\Application $application = null) : void
    {
    ...
    public function setHelperSet(\MonorepoBuilder20211223\Symfony\Component\Console\Helper\HelperSet $helperSet) : void
    {
        if ($this->command instanceof parent) {
