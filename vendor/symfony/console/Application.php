 ...
 */
namespace MonorepoBuilder202211\Symfony\Component\Console;

use MonorepoBuilder202211\Symfony\Component\Console\Command\Command;
use MonorepoBuilder202211\Symfony\Component\Console\Command\CompleteCommand;
use MonorepoBuilder202211\Symfony\Component\Console\Command\DumpCompletionCommand;
use MonorepoBuilder202211\Symfony\Component\Console\Command\HelpCommand;
use MonorepoBuilder202211\Symfony\Component\Console\Command\LazyCommand;
use MonorepoBuilder202211\Symfony\Component\Console\Command\ListCommand;
use MonorepoBuilder202211\Symfony\Component\Console\Command\SignalableCommandInterface;
use MonorepoBuilder202211\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use MonorepoBuilder202211\Symfony\Component\Console\Completion\CompletionInput;
use MonorepoBuilder202211\Symfony\Component\Console\Completion\CompletionSuggestions;
use MonorepoBuilder202211\Symfony\Component\Console\Event\ConsoleCommandEvent;
use MonorepoBuilder202211\Symfony\Component\Console\Event\ConsoleErrorEvent;
use MonorepoBuilder202211\Symfony\Component\Console\Event\ConsoleSignalEvent;
use MonorepoBuilder202211\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use MonorepoBuilder202211\Symfony\Component\Console\Exception\CommandNotFoundException;
use MonorepoBuilder202211\Symfony\Component\Console\Exception\ExceptionInterface;
use MonorepoBuilder202211\Symfony\Component\Console\Exception\LogicException;
use MonorepoBuilder202211\Symfony\Component\Console\Exception\NamespaceNotFoundException;
...
use MonorepoBuilder202211\Symfony\Component\Console\Helper\DebugFormatterHelper;
use MonorepoBuilder202211\Symfony\Component\Console\Helper\FormatterHelper;
use MonorepoBuilder202211\Symfony\Component\Console\Helper\Helper;
use MonorepoBuilder202211\Symfony\Component\Console\Helper\HelperSet;
use MonorepoBuilder202211\Symfony\Component\Console\Helper\ProcessHelper;
use MonorepoBuilder202211\Symfony\Component\Console\Helper\QuestionHelper;
use MonorepoBuilder202211\Symfony\Component\Console\Input\ArgvInput;
use MonorepoBuilder202211\Symfony\Component\Console\Input\ArrayInput;
use MonorepoBuilder202211\Symfony\Component\Console\Input\InputArgument;
use MonorepoBuilder202211\Symfony\Component\Console\Input\InputAwareInterface;
...
use MonorepoBuilder202211\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use MonorepoBuilder202211\Symfony\Component\Console\Style\SymfonyStyle;
use MonorepoBuilder202211\Symfony\Component\ErrorHandler\ErrorHandler;
use MonorepoBuilder202211\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use MonorepoBuilder202211\Symfony\Contracts\Service\ResetInterface;
/**
