...
use MonorepoBuilder20220608\Symfony\Component\Console\Command\CompleteCommand;
use MonorepoBuilder20220608\Symfony\Component\Console\Command\DumpCompletionCommand;
use MonorepoBuilder20220608\Symfony\Component\Console\Command\HelpCommand;
use MonorepoBuilder20220608\Symfony\Component\Console\Command\LazyCommand;
use MonorepoBuilder20220608\Symfony\Component\Console\Command\ListCommand;
use MonorepoBuilder20220608\Symfony\Component\Console\Command\SignalableCommandInterface;
use MonorepoBuilder20220608\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use MonorepoBuilder20220608\Symfony\Component\Console\Completion\CompletionInput;
use MonorepoBuilder20220608\Symfony\Component\Console\Completion\CompletionSuggestions;
use MonorepoBuilder20220608\Symfony\Component\Console\Event\ConsoleCommandEvent;
use MonorepoBuilder20220608\Symfony\Component\Console\Event\ConsoleErrorEvent;
use MonorepoBuilder20220608\Symfony\Component\Console\Event\ConsoleSignalEvent;
use MonorepoBuilder20220608\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use MonorepoBuilder20220608\Symfony\Component\Console\Exception\CommandNotFoundException;
use MonorepoBuilder20220608\Symfony\Component\Console\Exception\ExceptionInterface;
use MonorepoBuilder20220608\Symfony\Component\Console\Exception\LogicException;
use MonorepoBuilder20220608\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use MonorepoBuilder20220608\Symfony\Component\Console\Exception\RuntimeException;
use MonorepoBuilder20220608\Symfony\Component\Console\Formatter\OutputFormatter;
use MonorepoBuilder20220608\Symfony\Component\Console\Helper\DebugFormatterHelper;
use MonorepoBuilder20220608\Symfony\Component\Console\Helper\FormatterHelper;
use MonorepoBuilder20220608\Symfony\Component\Console\Helper\Helper;
use MonorepoBuilder20220608\Symfony\Component\Console\Helper\HelperSet;
use MonorepoBuilder20220608\Symfony\Component\Console\Helper\ProcessHelper;
use MonorepoBuilder20220608\Symfony\Component\Console\Helper\QuestionHelper;
use MonorepoBuilder20220608\Symfony\Component\Console\Input\ArgvInput;
use MonorepoBuilder20220608\Symfony\Component\Console\Input\ArrayInput;
use MonorepoBuilder20220608\Symfony\Component\Console\Input\InputArgument;
use MonorepoBuilder20220608\Symfony\Component\Console\Input\InputAwareInterface;
use MonorepoBuilder20220608\Symfony\Component\Console\Input\InputDefinition;
...
use MonorepoBuilder20220608\Symfony\Component\Console\Output\ConsoleOutput;
use MonorepoBuilder20220608\Symfony\Component\Console\Output\ConsoleOutputInterface;
use MonorepoBuilder20220608\Symfony\Component\Console\Output\OutputInterface;
use MonorepoBuilder20220608\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use MonorepoBuilder20220608\Symfony\Component\Console\Style\SymfonyStyle;
use MonorepoBuilder20220608\Symfony\Component\ErrorHandler\ErrorHandler;
use MonorepoBuilder20220608\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use MonorepoBuilder20220608\Symfony\Contracts\Service\ResetInterface;
/**
