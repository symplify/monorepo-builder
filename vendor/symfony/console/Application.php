 ...
 */
namespace MonorepoBuilderPrefix202308\Symfony\Component\Console;

use MonorepoBuilderPrefix202308\Symfony\Component\Console\Command\Command;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Command\CompleteCommand;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Command\DumpCompletionCommand;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Command\HelpCommand;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Command\LazyCommand;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Command\ListCommand;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Command\SignalableCommandInterface;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Completion\CompletionInput;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Completion\CompletionSuggestions;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Completion\Suggestion;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Event\ConsoleCommandEvent;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Event\ConsoleErrorEvent;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Event\ConsoleSignalEvent;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Exception\CommandNotFoundException;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Exception\ExceptionInterface;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Exception\LogicException;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Exception\RuntimeException;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Formatter\OutputFormatter;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Helper\DebugFormatterHelper;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Helper\DescriptorHelper;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Helper\FormatterHelper;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Helper\Helper;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Helper\HelperSet;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Helper\ProcessHelper;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Helper\QuestionHelper;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Input\ArgvInput;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Input\ArrayInput;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Input\InputArgument;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Input\InputAwareInterface;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Input\InputDefinition;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Input\InputInterface;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Input\InputOption;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Output\ConsoleOutput;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Output\ConsoleOutputInterface;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Output\OutputInterface;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use MonorepoBuilderPrefix202308\Symfony\Component\Console\Style\SymfonyStyle;
use MonorepoBuilderPrefix202308\Symfony\Component\ErrorHandler\ErrorHandler;
use MonorepoBuilderPrefix202308\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use MonorepoBuilderPrefix202308\Symfony\Contracts\Service\ResetInterface;
/**
