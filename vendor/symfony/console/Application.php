 ...
 */
namespace MonorepoBuilderPrefix202310\Symfony\Component\Console;

use MonorepoBuilderPrefix202310\Symfony\Component\Console\Command\Command;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Command\CompleteCommand;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Command\DumpCompletionCommand;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Command\HelpCommand;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Command\LazyCommand;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Command\ListCommand;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Command\SignalableCommandInterface;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Completion\CompletionInput;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Completion\CompletionSuggestions;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Completion\Suggestion;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Event\ConsoleCommandEvent;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Event\ConsoleErrorEvent;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Event\ConsoleSignalEvent;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Exception\CommandNotFoundException;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Exception\ExceptionInterface;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Exception\LogicException;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Exception\RuntimeException;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Formatter\OutputFormatter;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Helper\DebugFormatterHelper;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Helper\DescriptorHelper;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Helper\FormatterHelper;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Helper\Helper;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Helper\HelperSet;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Helper\ProcessHelper;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Helper\QuestionHelper;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Input\ArgvInput;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Input\ArrayInput;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Input\InputArgument;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Input\InputAwareInterface;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Input\InputDefinition;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Input\InputInterface;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Input\InputOption;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Output\ConsoleOutput;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Output\ConsoleOutputInterface;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Output\OutputInterface;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use MonorepoBuilderPrefix202310\Symfony\Component\Console\Style\SymfonyStyle;
use MonorepoBuilderPrefix202310\Symfony\Component\ErrorHandler\ErrorHandler;
use MonorepoBuilderPrefix202310\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use MonorepoBuilderPrefix202310\Symfony\Contracts\Service\ResetInterface;
/**
