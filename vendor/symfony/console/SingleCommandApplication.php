 ...
 */
class SingleCommandApplication extends \MonorepoBuilder20211203\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function run($input = null, $output = null) : int
    {
        ...
        $application = new \MonorepoBuilder20211203\Symfony\Component\Console\Application($this->getName() ?: 'UNKNOWN', $this->version);
