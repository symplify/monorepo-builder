 ...
 */
class SingleCommandApplication extends \MonorepoBuilder20210816\Symfony\Component\Console\Command\Command
{
    ...
    public function run($input = null, $output = null) : int
    {
        ...
        $application = new \MonorepoBuilder20210816\Symfony\Component\Console\Application($this->getName() ?: 'UNKNOWN', $this->version);
