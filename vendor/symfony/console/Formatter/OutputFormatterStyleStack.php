 ...
 */
class OutputFormatterStyleStack implements \MonorepoBuilder20210713\Symfony\Contracts\Service\ResetInterface
{
    /**
    ...
    private $styles;
    private $emptyStyle;
    public function __construct(\MonorepoBuilder20210713\Symfony\Component\Console\Formatter\OutputFormatterStyleInterface $emptyStyle = null)
    {
        $this->emptyStyle = $emptyStyle ?? new \MonorepoBuilder20210713\Symfony\Component\Console\Formatter\OutputFormatterStyle();
        $this->reset();
    }
    /**
    ...
    public function pop($style = null)
    {
        ...
        throw new \MonorepoBuilder20210713\Symfony\Component\Console\Exception\InvalidArgumentException('Incorrectly nested style tag found.');
    }
    /**
