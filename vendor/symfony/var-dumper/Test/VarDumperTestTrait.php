 ...
 */
namespace MonorepoBuilder20210913\Symfony\Component\VarDumper\Test;
...
trait VarDumperTestTrait
{
    ...
    protected function getDump($data, $key = null, $filter = 0) : ?string
    {
        if (null === ($flags = $this->varDumperConfig['flags'])) {
            $flags = \getenv('DUMP_LIGHT_ARRAY') ? \MonorepoBuilder20210913\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_LIGHT_ARRAY : 0;
            $flags |= \getenv('DUMP_STRING_LENGTH') ? \MonorepoBuilder20210913\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_STRING_LENGTH : 0;
            $flags |= \getenv('DUMP_COMMA_SEPARATOR') ? \MonorepoBuilder20210913\Symfony\Component\VarDumper\Dumper\CliDumper::DUMP_COMMA_SEPARATOR : 0;
        }
        ...
        $dumper = new \MonorepoBuilder20210913\Symfony\Component\VarDumper\Dumper\CliDumper(null, null, $flags);
