 ...
 */
class ClassStub extends \MonorepoBuilder20210826\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \MonorepoBuilder20210826\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \MonorepoBuilder20210826\Symfony\Component\VarDumper\Cloner\Stub(), \true, \MonorepoBuilder20210826\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                $s = \MonorepoBuilder20210826\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);
