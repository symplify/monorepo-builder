 ...
 */
class HtmlDumper extends \MonorepoBuilder20210911\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \MonorepoBuilder20210911\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
...
EOHTML
    ...
    public function enterHash($cursor, $type, $class, $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \MonorepoBuilder20210911\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\MonorepoBuilder20210911\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine($depth, $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \MonorepoBuilder20210911\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \MonorepoBuilder20210911\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
