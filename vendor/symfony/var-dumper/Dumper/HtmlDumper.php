 ...
 */
class HtmlDumper extends \MonorepoBuilder20210706\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \MonorepoBuilder20210706\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
     ...
     */
    public function dump(\MonorepoBuilder20210706\Symfony\Component\VarDumper\Cloner\Data $data, $output = null, $extraDisplayOptions = [])
    {
...
EOHTML
    ...
    public function enterHash(\MonorepoBuilder20210706\Symfony\Component\VarDumper\Cloner\Cursor $cursor, int $type, $class, bool $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \MonorepoBuilder20210706\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\MonorepoBuilder20210706\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine(int $depth, $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \MonorepoBuilder20210706\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \MonorepoBuilder20210706\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
