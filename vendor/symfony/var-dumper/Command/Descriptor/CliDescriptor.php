 ...
 * @final
 */
class CliDescriptor implements \MonorepoBuilder20210707\Symfony\Component\VarDumper\Command\Descriptor\DumpDescriptorInterface
{
    private $dumper;
    private $lastIdentifier;
    private $supportsHref;
    public function __construct(\MonorepoBuilder20210707\Symfony\Component\VarDumper\Dumper\CliDumper $dumper)
    {
        $this->dumper = $dumper;
        $this->supportsHref = \method_exists(\MonorepoBuilder20210707\Symfony\Component\Console\Formatter\OutputFormatterStyle::class, 'setHref');
    }
    ...
    {
        $io = $output instanceof \MonorepoBuilder20210707\Symfony\Component\Console\Style\SymfonyStyle ? $output : new \MonorepoBuilder20210707\Symfony\Component\Console\Style\SymfonyStyle(new \MonorepoBuilder20210707\Symfony\Component\Console\Input\ArrayInput([]), $output);
