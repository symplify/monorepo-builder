 ...
 */
class RequestMatcher implements \MonorepoBuilder20210707\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\MonorepoBuilder20210707\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\MonorepoBuilder20210707\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
