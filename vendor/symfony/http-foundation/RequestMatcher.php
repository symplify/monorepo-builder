 ...
 */
class RequestMatcher implements \MonorepoBuilder20211012\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches($request)
    {
        ...
        if (\MonorepoBuilder20211012\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
