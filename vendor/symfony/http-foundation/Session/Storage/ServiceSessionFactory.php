 ...
 */
final class ServiceSessionFactory implements \MonorepoBuilder20210708\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageFactoryInterface
{
    private $storage;
    public function __construct(\MonorepoBuilder20210708\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface $storage)
    {
    ...
    {
        if ($this->storage instanceof \MonorepoBuilder20210708\Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage && $request && $request->isSecure()) {
