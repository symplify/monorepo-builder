 ...
 */
class MockArraySessionStorage implements \MonorepoBuilder20210802\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface
{
    /**
     * @var string
     */
     ...
     */
    protected $bags = [];
    public function __construct(string $name = 'MOCKSESSID', \MonorepoBuilder20210802\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag $metaBag = null)
    {
        $this->name = $name;
    ...
    {
        if (null === $bag) {
            $bag = new \MonorepoBuilder20210802\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag();
        }
