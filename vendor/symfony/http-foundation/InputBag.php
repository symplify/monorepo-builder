...
use MonorepoBuilder20211010\Symfony\Component\HttpFoundation\Exception\BadRequestException;
/**
 * InputBag is a container for user input values such as $_GET, $_POST, $_REQUEST, and $_COOKIE.
 *
 * @author Saif Eddin Gmati <azjezz@protonmail.com>
 */
final class InputBag extends \MonorepoBuilder20211010\Symfony\Component\HttpFoundation\ParameterBag
{
    /**
    ...
    public function get($key, $default = null)
    {
        ...
        if (null !== $value && $this !== $value && !\is_scalar($value) && !(\is_object($value) && \method_exists($value, '__toString'))) {
            trigger_deprecation('symfony/http-foundation', '5.1', 'Retrieving a non-string value from "%s()" is deprecated, and will throw a "%s" exception in Symfony 6.0, use "%s::all($key)" instead.', __METHOD__, \MonorepoBuilder20211010\Symfony\Component\HttpFoundation\Exception\BadRequestException::class, __CLASS__);
        }
