...
final class ResponseCookieValueSame extends \MonorepoBuilder20210908\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\MonorepoBuilder20210908\Symfony\Component\HttpFoundation\Cookie
    {
