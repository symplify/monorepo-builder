...
final class ResponseCookieValueSame extends \MonorepoBuilder20210810\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\MonorepoBuilder20210810\Symfony\Component\HttpFoundation\Cookie
    {
