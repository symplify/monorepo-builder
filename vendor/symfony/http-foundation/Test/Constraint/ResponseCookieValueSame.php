...
final class ResponseCookieValueSame extends \MonorepoBuilder20210903\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\MonorepoBuilder20210903\Symfony\Component\HttpFoundation\Cookie
    {
