...
final class ResponseCookieValueSame extends \MonorepoBuilder20210907\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\MonorepoBuilder20210907\Symfony\Component\HttpFoundation\Cookie
    {
