...
final class ResponseCookieValueSame extends \MonorepoBuilder20210811\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\MonorepoBuilder20210811\Symfony\Component\HttpFoundation\Cookie
    {
