...
final class ResponseCookieValueSame extends \MonorepoBuilder20210904\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\MonorepoBuilder20210904\Symfony\Component\HttpFoundation\Cookie
    {
