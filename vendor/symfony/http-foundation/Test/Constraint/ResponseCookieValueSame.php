...
final class ResponseCookieValueSame extends \MonorepoBuilder20210827\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\MonorepoBuilder20210827\Symfony\Component\HttpFoundation\Cookie
    {
