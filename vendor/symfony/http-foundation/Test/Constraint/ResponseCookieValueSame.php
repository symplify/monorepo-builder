...
final class ResponseCookieValueSame extends \MonorepoBuilder20210721\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\MonorepoBuilder20210721\Symfony\Component\HttpFoundation\Cookie
    {
