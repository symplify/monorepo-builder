 ...
 */
final class ResponseFormatSame extends \MonorepoBuilder20210727\PHPUnit\Framework\Constraint\Constraint
{
    private $request;
    private $format;
    public function __construct(\MonorepoBuilder20210727\Symfony\Component\HttpFoundation\Request $request, ?string $format)
    {
