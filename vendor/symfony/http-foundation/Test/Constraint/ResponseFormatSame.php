 ...
 */
final class ResponseFormatSame extends \MonorepoBuilder20211023\PHPUnit\Framework\Constraint\Constraint
{
    private $request;
    private $format;
    public function __construct(\MonorepoBuilder20211023\Symfony\Component\HttpFoundation\Request $request, ?string $format)
    {
