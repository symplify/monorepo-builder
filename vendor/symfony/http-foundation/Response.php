...
class Response
{
    ...
    {
        $this->headers = new \MonorepoBuilder20210705\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\MonorepoBuilder20210705\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\MonorepoBuilder20210705\Symfony\Component\HttpFoundation\Request $request) : void
    {
