...
class HeaderBag implements \IteratorAggregate, \Countable
{
    ...
    protected function getCacheControlHeader()
    {
        ...
        return \MonorepoBuilder20211001\Symfony\Component\HttpFoundation\HeaderUtils::toString($this->cacheControl, ',');
    }
    /**
    ...
    {
        $parts = \MonorepoBuilder20211001\Symfony\Component\HttpFoundation\HeaderUtils::split($header, ',=');
        return \MonorepoBuilder20211001\Symfony\Component\HttpFoundation\HeaderUtils::combine($parts);
    }
}
