...
class ParameterBag implements \IteratorAggregate, \Countable
{
    ...
    public function all()
    {
        ...
        if (!\is_array($value = $this->parameters[$key] ?? [])) {
            throw new \MonorepoBuilder20210707\Symfony\Component\HttpFoundation\Exception\BadRequestException(\sprintf('Unexpected value for parameter "%s": expecting "array", got "%s".', $key, \get_debug_type($value)));
        }
        return $value;
    }
    /**
