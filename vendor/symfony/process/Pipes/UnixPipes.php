 ...
 * @internal
 */
class UnixPipes extends \MonorepoBuilder20210811\Symfony\Component\Process\Pipes\AbstractPipes
{
    private $ttyMode;
    private $ptyMode;
    ...
    public function getDescriptors() : array
    {
        ...
        if ($this->ptyMode && \MonorepoBuilder20210811\Symfony\Component\Process\Process::isPtySupported()) {
            return [['pty'], ['pty'], ['pty']];
        }
        return [
            ['pipe', 'r'],
    ...
    public function readAndWrite($blocking, $close = \false) : array
    {
        ...
        if (($r || $w) && \false === \stream_select($r, $w, $e, 0, $blocking ? \MonorepoBuilder20210811\Symfony\Component\Process\Process::TIMEOUT_PRECISION * 1000000.0 : 0)) {
