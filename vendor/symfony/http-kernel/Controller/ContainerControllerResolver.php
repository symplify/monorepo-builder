 ...
 */
class ContainerControllerResolver extends \MonorepoBuilder20210823\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\MonorepoBuilder20210823\Psr\Container\ContainerInterface $container, \MonorepoBuilder20210823\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \MonorepoBuilder20210823\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
