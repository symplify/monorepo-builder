 ...
 */
class ContainerControllerResolver extends \MonorepoBuilder20210712\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\MonorepoBuilder20210712\Psr\Container\ContainerInterface $container, \MonorepoBuilder20210712\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \MonorepoBuilder20210712\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
