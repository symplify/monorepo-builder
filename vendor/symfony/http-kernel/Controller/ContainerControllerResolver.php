 ...
 */
class ContainerControllerResolver extends \MonorepoBuilder20211031\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\MonorepoBuilder20211031\Psr\Container\ContainerInterface $container, \MonorepoBuilder20211031\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \MonorepoBuilder20211031\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
