 ...
 */
class ContainerControllerResolver extends \MonorepoBuilder20210913\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\MonorepoBuilder20210913\Psr\Container\ContainerInterface $container, \MonorepoBuilder20210913\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \MonorepoBuilder20210913\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
