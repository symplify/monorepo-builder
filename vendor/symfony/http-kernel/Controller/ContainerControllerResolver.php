 ...
 */
class ContainerControllerResolver extends \MonorepoBuilder20210816\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\MonorepoBuilder20210816\Psr\Container\ContainerInterface $container, \MonorepoBuilder20210816\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \MonorepoBuilder20210816\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
