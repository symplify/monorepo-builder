 ...
 */
class ContainerControllerResolver extends \MonorepoBuilder20211007\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\MonorepoBuilder20211007\Psr\Container\ContainerInterface $container, \MonorepoBuilder20211007\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \MonorepoBuilder20211007\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
