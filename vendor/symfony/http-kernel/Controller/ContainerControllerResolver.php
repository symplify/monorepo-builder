 ...
 */
class ContainerControllerResolver extends \MonorepoBuilder20210705\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\MonorepoBuilder20210705\Psr\Container\ContainerInterface $container, \MonorepoBuilder20210705\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \MonorepoBuilder20210705\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
