 ...
 */
class ContainerControllerResolver extends \MonorepoBuilder20211024\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\MonorepoBuilder20211024\Psr\Container\ContainerInterface $container, \MonorepoBuilder20211024\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \MonorepoBuilder20211024\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
