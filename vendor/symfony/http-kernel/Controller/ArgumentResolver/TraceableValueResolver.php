 ...
 */
final class TraceableValueResolver implements \MonorepoBuilder20210824\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $inner;
    private $stopwatch;
    public function __construct(\MonorepoBuilder20210824\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface $inner, \MonorepoBuilder20210824\Symfony\Component\Stopwatch\Stopwatch $stopwatch)
    {
        $this->inner = $inner;
