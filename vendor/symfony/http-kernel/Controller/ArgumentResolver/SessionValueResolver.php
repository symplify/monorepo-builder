 ...
 */
final class SessionValueResolver implements \MonorepoBuilder20210930\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
    ...
    public function supports($request, $argument) : bool
    {
        ...
        if (\MonorepoBuilder20210930\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \MonorepoBuilder20210930\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
