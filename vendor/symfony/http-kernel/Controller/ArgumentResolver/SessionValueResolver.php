 ...
 */
final class SessionValueResolver implements \MonorepoBuilder20210910\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
    ...
    public function supports($request, $argument) : bool
    {
        ...
        if (\MonorepoBuilder20210910\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \MonorepoBuilder20210910\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
