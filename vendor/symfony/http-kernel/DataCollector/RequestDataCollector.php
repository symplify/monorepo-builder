...
use MonorepoBuilder20210913\Symfony\Component\HttpFoundation\Cookie;
use MonorepoBuilder20210913\Symfony\Component\HttpFoundation\ParameterBag;
 ...
 * @final
 */
class RequestDataCollector extends \MonorepoBuilder20210913\Symfony\Component\HttpKernel\DataCollector\DataCollector implements \MonorepoBuilder20210913\Symfony\Component\EventDispatcher\EventSubscriberInterface, \MonorepoBuilder20210913\Symfony\Component\HttpKernel\DataCollector\LateDataCollectorInterface
{
    protected $controllers;
    private $sessionUsages = [];
    private $requestStack;
    public function __construct(\MonorepoBuilder20210913\Symfony\Component\HttpFoundation\RequestStack $requestStack = null)
    {
    ...
    public function collect($request, $response, $exception = null)
    {
        ...
        if ($response->isRedirect()) {
            $response->headers->setCookie(new \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\Cookie('sf_redirect', \json_encode(['token' => $response->headers->get('x-debug-token'), 'route' => $request->attributes->get('_route', 'n/a'), 'method' => $request->getMethod(), 'controller' => $this->parseController($request->attributes->get('_controller')), 'status_code' => $statusCode, 'status_text' => \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\Response::$statusTexts[(int) $statusCode]]), 0, '/', null, $request->isSecure(), \true, \false, 'lax'));
        }
    ...
    {
        return new \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_request']->getValue());
    }
    public function getRequestQuery()
    {
        return new \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_query']->getValue());
    }
    public function getRequestFiles()
    {
        return new \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_files']->getValue());
    }
    public function getRequestHeaders()
    {
        return new \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_headers']->getValue());
    }
    /**
     * @param bool $raw
     */
    ...
    {
        return new \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_server']->getValue($raw));
    }
    /**
     * @param bool $raw
     */
    ...
    {
        return new \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_cookies']->getValue($raw));
    }
    public function getRequestAttributes()
    {
        return new \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\ParameterBag($this->data['request_attributes']->getValue());
    }
    public function getResponseHeaders()
    {
        return new \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\ParameterBag($this->data['response_headers']->getValue());
    }
    public function getResponseCookies()
    {
        return new \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\ParameterBag($this->data['response_cookies']->getValue());
    }
    ...
    {
        return new \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\ParameterBag($this->data['dotenv_vars']->getValue());
    }
    /**
     * Gets the route name.
     *
    ...
    {
        return [\MonorepoBuilder20210913\Symfony\Component\HttpKernel\KernelEvents::CONTROLLER => 'onKernelController', \MonorepoBuilder20210913\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => 'onKernelResponse'];
    }
    /**
     * {@inheritdoc}
     */
    ...
    public function collectSessionUsage() : void
    {
        ...
        for ($i = $traceEndIndex; $i > 0; --$i) {
            if (null !== ($class = $trace[$i]['class'] ?? null) && (\is_subclass_of($class, \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\Session\SessionInterface::class) || \is_subclass_of($class, \MonorepoBuilder20210913\Symfony\Component\HttpFoundation\Session\SessionBagInterface::class))) {
                $traceEndIndex = $i;
                break;
            }
        }
