 ...
 * @final
 */
class ExceptionDataCollector extends \MonorepoBuilder20210820\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
    ...
    {
        if (null !== $exception) {
            $this->data = ['exception' => \MonorepoBuilder20210820\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}
