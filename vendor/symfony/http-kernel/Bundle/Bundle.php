...
use MonorepoBuilder20210811\Symfony\Component\DependencyInjection\ContainerAwareTrait;
 ...
 */
abstract class Bundle implements \MonorepoBuilder20210811\Symfony\Component\HttpKernel\Bundle\BundleInterface
{
    ...
    public function getContainerExtension()
    {
        if (null === $this->extension) {
            ...
            if (null !== $extension) {
                if (!$extension instanceof \MonorepoBuilder20210811\Symfony\Component\DependencyInjection\Extension\ExtensionInterface) {
                ...
                $expectedAlias = \MonorepoBuilder20210811\Symfony\Component\DependencyInjection\Container::underscore($basename);
