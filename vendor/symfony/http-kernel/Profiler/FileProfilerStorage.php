 ...
 */
class FileProfilerStorage implements \MonorepoBuilder20210706\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read(string $token) : ?\MonorepoBuilder20210706\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\MonorepoBuilder20210706\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\MonorepoBuilder20210706\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    protected function createProfileFromData(string $token, array $data, \MonorepoBuilder20210706\Symfony\Component\HttpKernel\Profiler\Profile $parent = null)
    {
        $profile = new \MonorepoBuilder20210706\Symfony\Component\HttpKernel\Profiler\Profile($token);
