 ...
 */
class FileProfilerStorage implements \MonorepoBuilder20210909\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * @param string $token
     */
    public function read($token) : ?\MonorepoBuilder20210909\Symfony\Component\HttpKernel\Profiler\Profile
    {
    ...
    public function write($profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\MonorepoBuilder20210909\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \MonorepoBuilder20210909\Symfony\Component\HttpKernel\Profiler\Profile($token);
