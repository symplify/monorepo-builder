 ...
 */
class FileProfilerStorage implements \MonorepoBuilder20211029\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * @param string $token
     */
    public function read($token) : ?\MonorepoBuilder20211029\Symfony\Component\HttpKernel\Profiler\Profile
    {
    ...
    public function write($profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\MonorepoBuilder20211029\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \MonorepoBuilder20211029\Symfony\Component\HttpKernel\Profiler\Profile($token);
