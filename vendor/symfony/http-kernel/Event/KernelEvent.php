 ...
 */
class KernelEvent extends \MonorepoBuilder20210826\Symfony\Contracts\EventDispatcher\Event
{
    private $kernel;
    private $request;
    private $requestType;
     ...
     */
    public function __construct(\MonorepoBuilder20210826\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \MonorepoBuilder20210826\Symfony\Component\HttpFoundation\Request $request, ?int $requestType)
    {
        $this->kernel = $kernel;
    ...
    {
        return \MonorepoBuilder20210826\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST === $this->requestType;
    }
    /**
