 ...
 */
namespace MonorepoBuilder20211001\Symfony\Component\HttpKernel\ControllerMetadata;

use MonorepoBuilder20211001\Symfony\Component\HttpKernel\Attribute\ArgumentInterface;
/**
...
class ArgumentMetadata
{
    ...
    public function __construct(string $name, ?string $type, bool $isVariadic, bool $hasDefaultValue, $defaultValue, bool $isNullable = \false, $attributes = [])
    {
        ...
        if (null === $attributes || $attributes instanceof \MonorepoBuilder20211001\Symfony\Component\HttpKernel\Attribute\ArgumentInterface) {
     ...
     */
    public function getAttribute() : ?\MonorepoBuilder20211001\Symfony\Component\HttpKernel\Attribute\ArgumentInterface
    {
        trigger_deprecation('symfony/http-kernel', '5.3', 'Method "%s()" is deprecated, use "getAttributes()" instead.', __METHOD__);
        if (!$this->attributes) {
            return null;
        }
        return $this->attributes[0] instanceof \MonorepoBuilder20211001\Symfony\Component\HttpKernel\Attribute\ArgumentInterface ? $this->attributes[0] : null;
    }
    /**
     * @return object[]
