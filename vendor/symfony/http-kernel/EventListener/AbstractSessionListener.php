...
use MonorepoBuilder20210816\Psr\Container\ContainerInterface;
use MonorepoBuilder20210816\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use MonorepoBuilder20210816\Symfony\Component\HttpFoundation\Session\Session;
...
use MonorepoBuilder20210816\Symfony\Component\HttpKernel\Exception\UnexpectedSessionUsageException;
 ...
 * @internal
 */
abstract class AbstractSessionListener implements \MonorepoBuilder20210816\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    public const NO_AUTO_CACHE_CONTROL_HEADER = 'Symfony-Session-NoAutoCacheControl';
    protected $container;
    private $sessionUsageStack = [];
    private $debug;
    public function __construct(\MonorepoBuilder20210816\Psr\Container\ContainerInterface $container = null, bool $debug = \false)
    {
    ...
    public function onKernelRequest($event)
    {
        ...
        $this->sessionUsageStack[] = $session instanceof \MonorepoBuilder20210816\Symfony\Component\HttpFoundation\Session\Session ? $session->getUsageIndex() : 0;
    }
    /**
    ...
    public function onKernelResponse($event)
    {
        ...
        if ($session instanceof \MonorepoBuilder20210816\Symfony\Component\HttpFoundation\Session\Session ? $session->getUsageIndex() === \end($this->sessionUsageStack) : !$session->isStarted()) {
            return;
        }
        if ($autoCacheControl) {
        ...
        if ($this->debug) {
            throw new \MonorepoBuilder20210816\Symfony\Component\HttpKernel\Exception\UnexpectedSessionUsageException('Session was used while the request was declared stateless.');
        }
    ...
    {
        return [
            \MonorepoBuilder20210816\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 128],
            // low priority to come after regular response listeners, but higher than StreamedResponseListener
            \MonorepoBuilder20210816\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -1000],
            \MonorepoBuilder20210816\Symfony\Component\HttpKernel\KernelEvents::FINISH_REQUEST => ['onFinishRequest'],
        ];
    }
    /**
