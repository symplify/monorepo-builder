 ...
 * @internal
 */
abstract class AbstractTestSessionListener implements \MonorepoBuilder20210708\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $sessionId;
    ...
    public function onKernelResponse(\MonorepoBuilder20210708\Symfony\Component\HttpKernel\Event\ResponseEvent $event)
    {
        ...
        if ($session instanceof \MonorepoBuilder20210708\Symfony\Component\HttpFoundation\Session\Session ? !$session->isEmpty() || null !== $this->sessionId && $session->getId() !== $this->sessionId : $wasStarted) {
            ...
            $event->getResponse()->headers->setCookie(new \MonorepoBuilder20210708\Symfony\Component\HttpFoundation\Cookie($session->getName(), $session->getId(), 0 === $params['lifetime'] ? 0 : \time() + $params['lifetime'], $params['path'], $params['domain'], $params['secure'], $params['httponly'], \false, $params['samesite'] ?: null));
            $this->sessionId = $session->getId();
        }
    }
    public static function getSubscribedEvents() : array
    {
        return [\MonorepoBuilder20210708\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 192], \MonorepoBuilder20210708\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -128]];
    }
    /**
