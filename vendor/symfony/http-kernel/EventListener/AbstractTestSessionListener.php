 ...
 * @internal
 */
abstract class AbstractTestSessionListener implements \MonorepoBuilder20210829\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $sessionId;
    ...
    public function onKernelResponse($event)
    {
        ...
        if ($session instanceof \MonorepoBuilder20210829\Symfony\Component\HttpFoundation\Session\Session ? !$session->isEmpty() || null !== $this->sessionId && $session->getId() !== $this->sessionId : $wasStarted) {
            ...
            $event->getResponse()->headers->setCookie(new \MonorepoBuilder20210829\Symfony\Component\HttpFoundation\Cookie($session->getName(), $session->getId(), 0 === $params['lifetime'] ? 0 : \time() + $params['lifetime'], $params['path'], $params['domain'], $params['secure'], $params['httponly'], \false, $params['samesite'] ?: null));
            $this->sessionId = $session->getId();
        }
    }
    public static function getSubscribedEvents() : array
    {
        return [\MonorepoBuilder20210829\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 192], \MonorepoBuilder20210829\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => ['onKernelResponse', -128]];
    }
    /**
