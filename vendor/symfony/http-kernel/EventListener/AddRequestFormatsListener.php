 ...
 * @final
 */
class AddRequestFormatsListener implements \MonorepoBuilder20211024\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\MonorepoBuilder20211024\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
