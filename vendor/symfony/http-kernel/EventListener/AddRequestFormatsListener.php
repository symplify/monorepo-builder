 ...
 * @final
 */
class AddRequestFormatsListener implements \MonorepoBuilder20210913\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\MonorepoBuilder20210913\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
