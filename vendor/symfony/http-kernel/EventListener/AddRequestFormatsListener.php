 ...
 * @final
 */
class AddRequestFormatsListener implements \MonorepoBuilder20210705\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\MonorepoBuilder20210705\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
