 ...
 * @final
 */
class AddRequestFormatsListener implements \MonorepoBuilder20210904\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\MonorepoBuilder20210904\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
