...
use MonorepoBuilder20210706\Symfony\Component\HttpKernel\HttpCache\HttpCache;
 ...
 * @final
 */
class SurrogateListener implements \MonorepoBuilder20210706\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $surrogate;
    public function __construct(\MonorepoBuilder20210706\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null)
    {
    ...
    public function onKernelResponse(\MonorepoBuilder20210706\Symfony\Component\HttpKernel\Event\ResponseEvent $event)
    {
        ...
        if ($kernel instanceof \MonorepoBuilder20210706\Symfony\Component\HttpKernel\HttpCache\HttpCache) {
