 ...
 * @final
 */
class ValidateRequestListener implements \MonorepoBuilder20211027\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        return [\MonorepoBuilder20211027\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 256]]];
    }
}
