 ...
 * @final
 */
class ValidateRequestListener implements \MonorepoBuilder20210707\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        return [\MonorepoBuilder20210707\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 256]]];
    }
}
