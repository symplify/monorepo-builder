 ...
 * @final
 */
class ValidateRequestListener implements \MonorepoBuilder20210714\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        return [\MonorepoBuilder20210714\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 256]]];
    }
}
