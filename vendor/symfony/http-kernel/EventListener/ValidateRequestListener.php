 ...
 * @final
 */
class ValidateRequestListener implements \MonorepoBuilder20210913\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        return [\MonorepoBuilder20210913\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 256]]];
    }
}
