 ...
 */
namespace MonorepoBuilder20210804\Symfony\Component\HttpKernel\HttpCache;
...
use MonorepoBuilder20210804\Symfony\Component\HttpKernel\TerminableInterface;
/**
 * Cache provides HTTP caching.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HttpCache implements \MonorepoBuilder20210804\Symfony\Component\HttpKernel\HttpKernelInterface, \MonorepoBuilder20210804\Symfony\Component\HttpKernel\TerminableInterface
{
    private $kernel;
    private $store;
    private $request;
     ...
     *                            (see RFC 5861).
     */
    public function __construct(\MonorepoBuilder20210804\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \MonorepoBuilder20210804\Symfony\Component\HttpKernel\HttpCache\StoreInterface $store, \MonorepoBuilder20210804\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null, array $options = [])
    {
        $this->store = $store;
        $this->kernel = $kernel;
    ...
    private function addTraces(\MonorepoBuilder20210804\Symfony\Component\HttpFoundation\Response $response)
    {
        $traceString = null;
    ...
    public function handle($request, $type = \MonorepoBuilder20210804\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST, $catch = \true)
    {
        ...
        if (\MonorepoBuilder20210804\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST === $type) {
            $this->traces = [];
    ...
    {
        if ($this->getKernel() instanceof \MonorepoBuilder20210804\Symfony\Component\HttpKernel\TerminableInterface) {
            ...
            try {
                ...
                foreach (['Location', 'Content-Location'] as $header) {
                    if ($uri = $response->headers->get($header)) {
                        $subRequest = \MonorepoBuilder20210804\Symfony\Component\HttpFoundation\Request::create($uri, 'get', [], [], [], $request->server->all());
    ...
    protected function forward($request, $catch = \false, $entry = null)
    {
        ...
        $response = \MonorepoBuilder20210804\Symfony\Component\HttpKernel\HttpCache\SubRequestHandler::handle($this->kernel, $request, \MonorepoBuilder20210804\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST, $catch);
        /*
     ...
     */
    private function restoreResponseBody(\MonorepoBuilder20210804\Symfony\Component\HttpFoundation\Request $request, \MonorepoBuilder20210804\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function isPrivateRequest(\MonorepoBuilder20210804\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     */
    private function record(\MonorepoBuilder20210804\Symfony\Component\HttpFoundation\Request $request, string $event)
    {
     ...
     */
    private function getTraceKey(\MonorepoBuilder20210804\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function mayServeStaleWhileRevalidate(\MonorepoBuilder20210804\Symfony\Component\HttpFoundation\Response $entry) : bool
    {
     ...
     */
    private function waitForLock(\MonorepoBuilder20210804\Symfony\Component\HttpFoundation\Request $request) : bool
    {
        $wait = 0;
