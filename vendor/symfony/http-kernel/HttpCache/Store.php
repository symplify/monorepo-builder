 ...
 */
class Store implements \MonorepoBuilder20211002\Symfony\Component\HttpKernel\HttpCache\StoreInterface
{
    protected $root;
    private $keyCache;
    private $locks;
    ...
    {
        $key = $this->getCacheKey(\MonorepoBuilder20211002\Symfony\Component\HttpFoundation\Request::create($url));
        if (isset($this->locks[$key])) {
            \flock($this->locks[$key], \LOCK_UN);
            \fclose($this->locks[$key]);
            unset($this->locks[$key]);
     ...
     */
    private function getCacheKey(\MonorepoBuilder20211002\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function persistRequest(\MonorepoBuilder20211002\Symfony\Component\HttpFoundation\Request $request) : array
    {
     ...
     */
    private function persistResponse(\MonorepoBuilder20211002\Symfony\Component\HttpFoundation\Response $response) : array
    {
     ...
     */
    private function restoreResponse(array $headers, string $path = null) : \MonorepoBuilder20211002\Symfony\Component\HttpFoundation\Response
    {
        ...
        return new \MonorepoBuilder20211002\Symfony\Component\HttpFoundation\Response($path, $status, $headers);
    }
}
