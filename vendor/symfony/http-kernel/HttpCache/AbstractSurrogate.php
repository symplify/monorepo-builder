 ...
 */
abstract class AbstractSurrogate implements \MonorepoBuilder20210907\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \MonorepoBuilder20210907\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
    ...
    {
        $subRequest = \MonorepoBuilder20210907\Symfony\Component\HttpFoundation\Request::create($uri, \MonorepoBuilder20210907\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \MonorepoBuilder20210907\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
