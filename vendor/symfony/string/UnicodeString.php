 ...
 */
class UnicodeString extends \MonorepoBuilder20220207\Symfony\Component\String\AbstractUnicodeString
{
    ...
    public function split(string $delimiter, int $limit = null, int $flags = null) : array
    {
        ...
        if (\false === $delimiter) {
            throw new \MonorepoBuilder20220207\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is not a valid UTF-8 string.');
        }
        $str = clone $this;
        $tail = $this->string;
        $chunks = [];
