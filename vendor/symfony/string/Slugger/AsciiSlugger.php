 ...
 */
namespace MonorepoBuilder20210707\Symfony\Component\String\Slugger;

use MonorepoBuilder20210707\Symfony\Component\String\AbstractUnicodeString;
...
if (!\interface_exists(\MonorepoBuilder20210707\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \MonorepoBuilder20210707\Symfony\Component\String\Slugger\SluggerInterface, \MonorepoBuilder20210707\Symfony\Contracts\Translation\LocaleAwareInterface
{
     ...
     * {@inheritdoc}
     */
    public function slug(string $string, string $separator = '-', string $locale = null) : \MonorepoBuilder20210707\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \MonorepoBuilder20210707\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
