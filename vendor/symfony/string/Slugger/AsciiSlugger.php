...
if (!\interface_exists(\MonorepoBuilder20210708\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \MonorepoBuilder20210708\Symfony\Component\String\Slugger\SluggerInterface, \MonorepoBuilder20210708\Symfony\Contracts\Translation\LocaleAwareInterface
{
    ...
    public function slug(string $string, string $separator = '-', string $locale = null) : \MonorepoBuilder20210708\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \MonorepoBuilder20210708\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
