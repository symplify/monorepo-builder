 ...
 */
namespace MonorepoBuilder20211210\Symfony\Component\String\Slugger;

use MonorepoBuilder20211210\Symfony\Component\String\AbstractUnicodeString;
use MonorepoBuilder20211210\Symfony\Component\String\UnicodeString;
use MonorepoBuilder20211210\Symfony\Contracts\Translation\LocaleAwareInterface;
if (!\interface_exists(\MonorepoBuilder20211210\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \MonorepoBuilder20211210\Symfony\Component\String\Slugger\SluggerInterface, \MonorepoBuilder20211210\Symfony\Contracts\Translation\LocaleAwareInterface
{
    ...
    public function slug($string, $separator = '-', $locale = null) : \MonorepoBuilder20211210\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \MonorepoBuilder20211210\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
