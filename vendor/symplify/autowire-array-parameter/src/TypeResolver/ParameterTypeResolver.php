...
namespace MonorepoBuilder20220117\Symplify\AutowireArrayParameter\TypeResolver;

use MonorepoBuilder20220117\Nette\Utils\Reflection;
...
final class ParameterTypeResolver
{
    ...
    public function __construct(\MonorepoBuilder20220117\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver $paramTypeDocBlockResolver)
    {
    ...
    public function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $resolvedClass = \MonorepoBuilder20220117\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringReflectionClass);
