...
namespace MonorepoBuilder20211210\Symplify\AutowireArrayParameter\TypeResolver;

use MonorepoBuilder20211210\Nette\Utils\Reflection;
...
final class ParameterTypeResolver
{
    ...
    public function __construct(\MonorepoBuilder20211210\Symplify\AutowireArrayParameter\DocBlock\ParamTypeDocBlockResolver $paramTypeDocBlockResolver)
    {
    ...
    public function resolveParameterType(string $parameterName, \ReflectionMethod $reflectionMethod) : ?string
    {
        ...
        $resolvedClass = \MonorepoBuilder20211210\Nette\Utils\Reflection::expandClassName($resolvedType, $declaringReflectionClass);
