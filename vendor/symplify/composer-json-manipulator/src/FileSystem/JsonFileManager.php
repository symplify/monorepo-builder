...
final class JsonFileManager
{
     ...
     */
    private $jsonInliner;
    public function __construct(\MonorepoBuilder20220607\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \MonorepoBuilder20220607\Symplify\ComposerJsonManipulator\Json\JsonCleaner $jsonCleaner, \MonorepoBuilder20220607\Symplify\ComposerJsonManipulator\Json\JsonInliner $jsonInliner)
    {
     ...
     * @return mixed[]
     */
    public function loadFromFileInfo(\MonorepoBuilder20220607\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : array
    {
        $realPath = $smartFileInfo->getRealPath();
        if (!isset($this->cachedJSONFiles[$realPath])) {
            $this->cachedJSONFiles[$realPath] = \MonorepoBuilder20220607\Nette\Utils\Json::decode($smartFileInfo->getContents(), \MonorepoBuilder20220607\Nette\Utils\Json::FORCE_ARRAY);
        }
    ...
    public function loadFromFilePath(string $filePath) : array
    {
        ...
        return \MonorepoBuilder20220607\Nette\Utils\Json::decode($fileContent, \MonorepoBuilder20220607\Nette\Utils\Json::FORCE_ARRAY);
    }
    /**
     * @param mixed[] $json
     */
    public function printJsonToFileInfo(array $json, \MonorepoBuilder20220607\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
    ...
    public function printComposerJsonToFilePath(\MonorepoBuilder20220607\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, string $filePath) : string
    {
    ...
    public function encodeJsonToFileContent(array $json) : string
    {
        ...
        $jsonContent = \MonorepoBuilder20220607\Nette\Utils\Json::encode($json, \MonorepoBuilder20220607\Nette\Utils\Json::PRETTY) . \MonorepoBuilder20220607\Symplify\PackageBuilder\Configuration\StaticEolConfiguration::getEolChar();
