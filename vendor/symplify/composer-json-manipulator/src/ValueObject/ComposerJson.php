...
namespace MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject;

use MonorepoBuilder20211010\Nette\Utils\Arrays;
use MonorepoBuilder20211010\Nette\Utils\Strings;
use MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\Sorter\ComposerPackageSorter;
...
final class ComposerJson
{
    ...
    {
        $this->composerPackageSorter = new \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\Sorter\ComposerPackageSorter();
    }
    public function setOriginalFileInfo(\MonorepoBuilder20211010\Symplify\SmartFileSystem\SmartFileInfo $fileInfo) : void
    {
    ...
    public function getAbsoluteAutoloadDirectories() : array
    {
        if ($this->fileInfo === null) {
            throw new \MonorepoBuilder20211010\Symplify\SymplifyKernel\Exception\ShouldNotHappenException();
        }
    ...
    public function getShortName() : ?string
    {
        ...
        return \MonorepoBuilder20211010\Nette\Utils\Strings::after($this->name, '/', -1);
    }
    /**
     * @return string[]
     */
    ...
    {
        $array = \array_filter([\MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::NAME => $this->name, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::DESCRIPTION => $this->description, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::KEYWORDS => $this->keywords, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::HOMEPAGE => $this->homepage, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::LICENSE => $this->license, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTHORS => $this->authors, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::TYPE => $this->type, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE => $this->require, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REQUIRE_DEV => $this->requireDev, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD => $this->autoload, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::AUTOLOAD_DEV => $this->autoloadDev, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REPOSITORIES => $this->repositories, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::EXTRA => $this->extra, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::BIN => $this->bin, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::SCRIPTS => $this->scripts, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::SCRIPTS_DESCRIPTIONS => $this->scriptsDescriptions, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::SUGGEST => $this->suggest, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::CONFIG => $this->config, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::REPLACE => $this->replace, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::CONFLICT => $this->conflicts, \MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::VERSION => $this->version]);
        if ($this->minimumStability !== null) {
            $array[\MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::MINIMUM_STABILITY] = $this->minimumStability;
            $this->moveValueToBack(\MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::MINIMUM_STABILITY);
        }
        if ($this->preferStable !== null) {
            $array[\MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::PREFER_STABLE] = $this->preferStable;
            $this->moveValueToBack(\MonorepoBuilder20211010\Symplify\ComposerJsonManipulator\ValueObject\ComposerJsonSection::PREFER_STABLE);
        }
    ...
    public function getFileInfo() : ?\MonorepoBuilder20211010\Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    public function getAutoloadDirectories() : array
    {
        ...
        return \MonorepoBuilder20211010\Nette\Utils\Arrays::flatten($autoloadDirectories);
    }
    /**
     * @return string[]
     */
