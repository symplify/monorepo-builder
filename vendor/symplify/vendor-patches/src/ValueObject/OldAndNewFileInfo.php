...
namespace MonorepoBuilder20220530\Symplify\VendorPatches\ValueObject;
...
final class OldAndNewFileInfo
{
     ...
     */
    private $packageName;
    public function __construct(\MonorepoBuilder20220530\Symplify\SmartFileSystem\SmartFileInfo $oldFileInfo, \MonorepoBuilder20220530\Symplify\SmartFileSystem\SmartFileInfo $newFileInfo, string $packageName)
    {
        $this->oldFileInfo = $oldFileInfo;
        $this->newFileInfo = $newFileInfo;
        $this->packageName = $packageName;
    }
    public function getOldFileInfo() : \MonorepoBuilder20220530\Symplify\SmartFileSystem\SmartFileInfo
    {
    ...
    public function getNewFileInfo() : \MonorepoBuilder20220530\Symplify\SmartFileSystem\SmartFileInfo
    {
