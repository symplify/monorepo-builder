...
namespace MonorepoBuilder20220525\Symplify\VendorPatches\Command;
...
use MonorepoBuilder20220525\Symplify\PackageBuilder\Console\Command\CommandNaming;
use MonorepoBuilder20220525\Symplify\VendorPatches\Composer\ComposerPatchesConfigurationUpdater;
use MonorepoBuilder20220525\Symplify\VendorPatches\Console\GenerateCommandReporter;
use MonorepoBuilder20220525\Symplify\VendorPatches\Differ\PatchDiffer;
use MonorepoBuilder20220525\Symplify\VendorPatches\Finder\OldToNewFilesFinder;
use MonorepoBuilder20220525\Symplify\VendorPatches\PatchFileFactory;
final class GenerateCommand extends \MonorepoBuilder20220525\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\MonorepoBuilder20220525\Symplify\VendorPatches\Finder\OldToNewFilesFinder $oldToNewFilesFinder, \MonorepoBuilder20220525\Symplify\VendorPatches\Differ\PatchDiffer $patchDiffer, \MonorepoBuilder20220525\Symplify\VendorPatches\Composer\ComposerPatchesConfigurationUpdater $composerPatchesConfigurationUpdater, \MonorepoBuilder20220525\Symplify\PackageBuilder\Composer\VendorDirProvider $vendorDirProvider, \MonorepoBuilder20220525\Symplify\VendorPatches\PatchFileFactory $patchFileFactory, \MonorepoBuilder20220525\Symplify\VendorPatches\Console\GenerateCommandReporter $generateCommandReporter)
    {
    ...
    {
        $this->setName(\MonorepoBuilder20220525\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(self::class));
