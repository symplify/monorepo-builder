...
namespace MonorepoBuilder20220530\Symplify\VendorPatches\Command;
...
use MonorepoBuilder20220530\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
use MonorepoBuilder20220530\Symplify\PackageBuilder\Console\Command\CommandNaming;
use MonorepoBuilder20220530\Symplify\VendorPatches\Composer\ComposerPatchesConfigurationUpdater;
use MonorepoBuilder20220530\Symplify\VendorPatches\Console\GenerateCommandReporter;
use MonorepoBuilder20220530\Symplify\VendorPatches\Differ\PatchDiffer;
use MonorepoBuilder20220530\Symplify\VendorPatches\Finder\OldToNewFilesFinder;
use MonorepoBuilder20220530\Symplify\VendorPatches\PatchFileFactory;
final class GenerateCommand extends \MonorepoBuilder20220530\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\MonorepoBuilder20220530\Symplify\VendorPatches\Finder\OldToNewFilesFinder $oldToNewFilesFinder, \MonorepoBuilder20220530\Symplify\VendorPatches\Differ\PatchDiffer $patchDiffer, \MonorepoBuilder20220530\Symplify\VendorPatches\Composer\ComposerPatchesConfigurationUpdater $composerPatchesConfigurationUpdater, \MonorepoBuilder20220530\Symplify\PackageBuilder\Composer\VendorDirProvider $vendorDirProvider, \MonorepoBuilder20220530\Symplify\VendorPatches\PatchFileFactory $patchFileFactory, \MonorepoBuilder20220530\Symplify\VendorPatches\Console\GenerateCommandReporter $generateCommandReporter)
    {
    ...
    {
        $this->setName(\MonorepoBuilder20220530\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(self::class));
