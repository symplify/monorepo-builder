...
namespace MonorepoBuilder20220530\Symplify\VendorPatches\Composer;
...
use MonorepoBuilder20220530\Symplify\VendorPatches\FileSystem\PathResolver;
/**
...
final class PackageNameResolver
{
    ...
    public function __construct(\MonorepoBuilder20220530\Symplify\SmartFileSystem\Json\JsonFileSystem $jsonFileSystem, \MonorepoBuilder20220530\Symplify\VendorPatches\FileSystem\PathResolver $pathResolver, \MonorepoBuilder20220530\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard)
    {
        $this->jsonFileSystem = $jsonFileSystem;
        $this->pathResolver = $pathResolver;
        $this->fileSystemGuard = $fileSystemGuard;
    }
    public function resolveFromFileInfo(\MonorepoBuilder20220530\Symplify\SmartFileSystem\SmartFileInfo $vendorFile) : string
    {
    ...
    private function getPackageComposerJsonFilePath(\MonorepoBuilder20220530\Symplify\SmartFileSystem\SmartFileInfo $vendorFileInfo) : string
    {
