...
namespace MonorepoBuilder20211101\Symplify\PackageBuilder\Reflection;

use ReflectionProperty;
use MonorepoBuilder20211101\Symplify\PHPStanRules\Exception\ShouldNotHappenException;
/**
 * @api
...
final class PrivatesAccessor
{
    ...
    private function resolvePropertyReflection($object, string $propertyName) : \ReflectionProperty
    {
        ...
        if ($parentClass === \false) {
            throw new \MonorepoBuilder20211101\Symplify\PHPStanRules\Exception\ShouldNotHappenException();
        }
