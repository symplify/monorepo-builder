...
use MonorepoBuilder20210818\Symplify\PHPStanRules\Exception\ShouldNotHappenException;
/**
...
final class PrivatesAccessor
{
    ...
    private function resolvePropertyReflection($object, string $propertyName) : \ReflectionProperty
    {
        ...
        if ($parentClass === \false) {
            throw new \MonorepoBuilder20210818\Symplify\PHPStanRules\Exception\ShouldNotHappenException();
        }
