...
namespace MonorepoBuilder20220529\Symplify\PackageBuilder\Reflection;

use ReflectionProperty;
use MonorepoBuilder20220529\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use MonorepoBuilder20220529\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
...
final class PrivatesAccessor
{
    ...
    public function getPrivatePropertyOfClass(object $object, string $propertyName, string $valueClassName) : object
    {
        ...
        throw new \MonorepoBuilder20220529\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException($errorMessage);
    }
    /**
     * @return mixed
     */
    ...
    private function resolvePropertyReflection(object $object, string $propertyName) : \ReflectionProperty
    {
        ...
        throw new \MonorepoBuilder20220529\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException($errorMessage);
    }
}
