...
use MonorepoBuilderPrefix202311\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use MonorepoBuilderPrefix202311\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
