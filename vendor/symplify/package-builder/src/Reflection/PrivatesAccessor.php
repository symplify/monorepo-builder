...
namespace MonorepoBuilder20220103\Symplify\PackageBuilder\Reflection;

use ReflectionProperty;
use MonorepoBuilder20220103\Symplify\PHPStanRules\Exception\ShouldNotHappenException;
/**
 * @api
...
final class PrivatesAccessor
{
    ...
    public function getPrivatePropertyOfClass($object, string $propertyName, string $valueClassName)
    {
        ...
        throw new \MonorepoBuilder20220103\Symplify\PHPStanRules\Exception\ShouldNotHappenException();
    }
    /**
     * @return mixed
     * @param object $object
    ...
    private function resolvePropertyReflection($object, string $propertyName) : \ReflectionProperty
    {
        ...
        if ($parentClass === \false) {
            ...
            throw new \MonorepoBuilder20220103\Symplify\PHPStanRules\Exception\ShouldNotHappenException($errorMessage);
        }
