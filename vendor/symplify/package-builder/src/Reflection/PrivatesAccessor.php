...
namespace MonorepoBuilder20211120\Symplify\PackageBuilder\Reflection;

use ReflectionProperty;
use MonorepoBuilder20211120\Symplify\PHPStanRules\Exception\ShouldNotHappenException;
/**
 * @api
...
final class PrivatesAccessor
{
    ...
    private function resolvePropertyReflection($object, string $propertyName) : \ReflectionProperty
    {
        ...
        if ($parentClass === \false) {
            throw new \MonorepoBuilder20211120\Symplify\PHPStanRules\Exception\ShouldNotHappenException();
        }
