...
namespace MonorepoBuilder20220225\Symplify\PackageBuilder\Reflection;

use ReflectionProperty;
use MonorepoBuilder20220225\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use MonorepoBuilder20220225\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
...
final class PrivatesAccessor
{
    ...
    public function getPrivatePropertyOfClass($object, string $propertyName, string $valueClassName)
    {
        ...
        throw new \MonorepoBuilder20220225\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException($errorMessage);
    }
    /**
     * @return mixed
     * @param object $object
    ...
    private function resolvePropertyReflection($object, string $propertyName) : \ReflectionProperty
    {
        ...
        throw new \MonorepoBuilder20220225\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException($errorMessage);
    }
}
