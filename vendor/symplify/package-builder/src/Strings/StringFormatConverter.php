...
namespace MonorepoBuilder20211031\Symplify\PackageBuilder\Strings;
...
final class StringFormatConverter
{
    ...
    {
        $matches = \MonorepoBuilder20211031\Nette\Utils\Strings::matchAll($input, self::BIG_LETTER_REGEX);
        $parts = [];
