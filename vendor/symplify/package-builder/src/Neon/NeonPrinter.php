...
namespace MonorepoBuilder20211110\Symplify\PackageBuilder\Neon;

use MonorepoBuilder20211110\Nette\Neon\Encoder;
use MonorepoBuilder20211110\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \MonorepoBuilder20211110\Nette\Neon\Neon::encode($phpStanNeon, \MonorepoBuilder20211110\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \MonorepoBuilder20211110\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \MonorepoBuilder20211110\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \MonorepoBuilder20211110\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
