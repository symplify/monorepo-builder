...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\MonorepoBuilder20210715\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\MonorepoBuilder20210715\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \MonorepoBuilder20210715\Symplify\SmartFileSystem\SmartFileInfo) {
