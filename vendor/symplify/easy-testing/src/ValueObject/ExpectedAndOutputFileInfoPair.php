...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\MonorepoBuilder20220530\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\MonorepoBuilder20220530\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \MonorepoBuilder20220530\Symplify\SmartFileSystem\SmartFileInfo) {
