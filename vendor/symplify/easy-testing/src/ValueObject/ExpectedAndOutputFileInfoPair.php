...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\MonorepoBuilder20211112\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\MonorepoBuilder20211112\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \MonorepoBuilder20211112\Symplify\SmartFileSystem\SmartFileInfo) {
