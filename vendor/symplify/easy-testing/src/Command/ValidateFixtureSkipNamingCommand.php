...
namespace MonorepoBuilder20220303\Symplify\EasyTesting\Command;
...
use MonorepoBuilder20220303\Symplify\EasyTesting\Finder\FixtureFinder;
use MonorepoBuilder20220303\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use MonorepoBuilder20220303\Symplify\EasyTesting\ValueObject\Option;
use MonorepoBuilder20220303\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \MonorepoBuilder20220303\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\MonorepoBuilder20220303\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \MonorepoBuilder20220303\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\MonorepoBuilder20220303\Symplify\EasyTesting\ValueObject\Option::SOURCE, \MonorepoBuilder20220303\Symfony\Component\Console\Input\InputArgument::REQUIRED | \MonorepoBuilder20220303\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\MonorepoBuilder20220303\Symplify\EasyTesting\ValueObject\Option::SOURCE);
