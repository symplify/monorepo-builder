...
namespace MonorepoBuilder20210922\Symplify\EasyTesting\Command;
...
use MonorepoBuilder20210922\Symplify\EasyTesting\Finder\FixtureFinder;
use MonorepoBuilder20210922\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use MonorepoBuilder20210922\Symplify\EasyTesting\ValueObject\Option;
use MonorepoBuilder20210922\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \MonorepoBuilder20210922\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\MonorepoBuilder20210922\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \MonorepoBuilder20210922\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\MonorepoBuilder20210922\Symplify\EasyTesting\ValueObject\Option::SOURCE, \MonorepoBuilder20210922\Symfony\Component\Console\Input\InputArgument::REQUIRED | \MonorepoBuilder20210922\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\MonorepoBuilder20210922\Symplify\EasyTesting\ValueObject\Option::SOURCE);
