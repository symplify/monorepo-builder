...
namespace MonorepoBuilder20220527\Symplify\EasyTesting\Command;
...
use MonorepoBuilder20220527\Symplify\EasyTesting\Finder\FixtureFinder;
use MonorepoBuilder20220527\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use MonorepoBuilder20220527\Symplify\EasyTesting\ValueObject\Option;
use MonorepoBuilder20220527\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \MonorepoBuilder20220527\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\MonorepoBuilder20220527\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \MonorepoBuilder20220527\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\MonorepoBuilder20220527\Symplify\EasyTesting\ValueObject\Option::SOURCE, \MonorepoBuilder20220527\Symfony\Component\Console\Input\InputArgument::REQUIRED | \MonorepoBuilder20220527\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\MonorepoBuilder20220527\Symplify\EasyTesting\ValueObject\Option::SOURCE);
