...
namespace MonorepoBuilder20211008\Symplify\EasyTesting\Command;
...
use MonorepoBuilder20211008\Symplify\EasyTesting\Finder\FixtureFinder;
use MonorepoBuilder20211008\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use MonorepoBuilder20211008\Symplify\EasyTesting\ValueObject\Option;
use MonorepoBuilder20211008\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \MonorepoBuilder20211008\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\MonorepoBuilder20211008\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \MonorepoBuilder20211008\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\MonorepoBuilder20211008\Symplify\EasyTesting\ValueObject\Option::SOURCE, \MonorepoBuilder20211008\Symfony\Component\Console\Input\InputArgument::REQUIRED | \MonorepoBuilder20211008\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\MonorepoBuilder20211008\Symplify\EasyTesting\ValueObject\Option::SOURCE);
