...
namespace MonorepoBuilder20210811\Symplify\EasyTesting\Command;
...
use MonorepoBuilder20210811\Symplify\EasyTesting\Finder\FixtureFinder;
use MonorepoBuilder20210811\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use MonorepoBuilder20210811\Symplify\EasyTesting\ValueObject\Option;
use MonorepoBuilder20210811\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \MonorepoBuilder20210811\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\MonorepoBuilder20210811\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \MonorepoBuilder20210811\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\MonorepoBuilder20210811\Symplify\EasyTesting\ValueObject\Option::SOURCE, \MonorepoBuilder20210811\Symfony\Component\Console\Input\InputArgument::REQUIRED | \MonorepoBuilder20210811\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\MonorepoBuilder20210811\Symplify\EasyTesting\ValueObject\Option::SOURCE);
