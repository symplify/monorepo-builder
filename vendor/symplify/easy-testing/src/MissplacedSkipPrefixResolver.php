...
use MonorepoBuilder20211010\Symplify\EasyTesting\ValueObject\Prefix;
...
final class MissplacedSkipPrefixResolver
{
    ...
    public function resolve(array $fixtureFileInfos) : array
    {
        ...
        foreach ($fixtureFileInfos as $fixtureFileInfo) {
            ...
            $hasSplitLine = (bool) \MonorepoBuilder20211010\Nette\Utils\Strings::match($fileContents, \MonorepoBuilder20211010\Symplify\EasyTesting\ValueObject\SplitLine::SPLIT_LINE_REGEX);
    ...
    private function hasNameSkipStart(\MonorepoBuilder20211010\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : bool
    {
        return (bool) \MonorepoBuilder20211010\Nette\Utils\Strings::match($fixtureFileInfo->getBasenameWithoutSuffix(), \MonorepoBuilder20211010\Symplify\EasyTesting\ValueObject\Prefix::SKIP_PREFIX_REGEX);
    }
}
