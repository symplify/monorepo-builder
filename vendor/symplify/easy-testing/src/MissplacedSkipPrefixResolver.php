...
final class MissplacedSkipPrefixResolver
{
    ...
    {
        return (bool) \MonorepoBuilder20220305\Nette\Utils\Strings::match($fixtureFileInfo->getBasenameWithoutSuffix(), \MonorepoBuilder20220305\Symplify\EasyTesting\ValueObject\Prefix::SKIP_PREFIX_REGEX);
    }
}
