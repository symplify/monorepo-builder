...
use MonorepoBuilder20211207\Symplify\PackageBuilder\Reflection\PrivatesAccessor;
use MonorepoBuilder20211207\Symplify\SmartFileSystem\FileSystemFilter;
...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    // filesystem
    $services->set(\MonorepoBuilder20211207\Symplify\SmartFileSystem\Finder\FinderSanitizer::class);
    $services->set(\MonorepoBuilder20211207\Symplify\SmartFileSystem\SmartFileSystem::class);
    $services->set(\MonorepoBuilder20211207\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    $services->set(\MonorepoBuilder20211207\Symplify\SmartFileSystem\FileSystemGuard::class);
    $services->set(\MonorepoBuilder20211207\Symplify\SmartFileSystem\FileSystemFilter::class);
    ...
    $services->set(\MonorepoBuilder20211207\Symplify\PackageBuilder\Reflection\PrivatesAccessor::class);
};
