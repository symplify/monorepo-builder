...
use MonorepoBuilder20210705\Symplify\SmartFileSystem\FileSystemFilter;
...
return static function (\MonorepoBuilder20210705\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    // filesystem
    $services->set(\MonorepoBuilder20210705\Symplify\SmartFileSystem\Finder\FinderSanitizer::class);
    $services->set(\MonorepoBuilder20210705\Symplify\SmartFileSystem\SmartFileSystem::class);
    $services->set(\MonorepoBuilder20210705\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    $services->set(\MonorepoBuilder20210705\Symplify\SmartFileSystem\FileSystemGuard::class);
    $services->set(\MonorepoBuilder20210705\Symplify\SmartFileSystem\FileSystemFilter::class);
