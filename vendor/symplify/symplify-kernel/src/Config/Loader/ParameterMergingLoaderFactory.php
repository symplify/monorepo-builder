...
namespace MonorepoBuilder20211210\Symplify\SymplifyKernel\Config\Loader;

use MonorepoBuilder20211210\Symfony\Component\Config\FileLocator;
use MonorepoBuilder20211210\Symfony\Component\Config\Loader\DelegatingLoader;
use MonorepoBuilder20211210\Symfony\Component\Config\Loader\GlobFileLoader;
use MonorepoBuilder20211210\Symfony\Component\Config\Loader\LoaderResolver;
use MonorepoBuilder20211210\Symfony\Component\DependencyInjection\ContainerBuilder;
use MonorepoBuilder20211210\Symplify\PackageBuilder\DependencyInjection\FileLoader\ParameterMergingPhpFileLoader;
...
final class ParameterMergingLoaderFactory implements \MonorepoBuilder20211210\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface
{
    ...
    public function create($containerBuilder, $currentWorkingDirectory) : \MonorepoBuilder20211210\Symfony\Component\Config\Loader\LoaderInterface
    {
        ...
        $loaderResolver = new \MonorepoBuilder20211210\Symfony\Component\Config\Loader\LoaderResolver($loaders);
        return new \MonorepoBuilder20211210\Symfony\Component\Config\Loader\DelegatingLoader($loaderResolver);
    }
}
