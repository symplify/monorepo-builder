...
namespace MonorepoBuilder20220124\Symplify\SymplifyKernel;
...
use MonorepoBuilder20220124\Symplify\SymplifyKernel\DependencyInjection\LoadExtensionConfigsCompilerPass;
use MonorepoBuilder20220124\Webmozart\Assert\Assert;
final class ContainerBuilderFactory
{
    ...
    public function __construct(\MonorepoBuilder20220124\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface $loaderFactory)
    {
    ...
    public function create(array $extensions, array $compilerPasses, array $configFiles) : \MonorepoBuilder20220124\Symfony\Component\DependencyInjection\ContainerBuilder
    {
        ...
        $compilerPassConfig->setMergePass(new \MonorepoBuilder20220124\Symplify\SymplifyKernel\DependencyInjection\LoadExtensionConfigsCompilerPass());
        return $containerBuilder;
    }
    /**
     * @param ExtensionInterface[] $extensions
     */
    private function registerExtensions(\MonorepoBuilder20220124\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, array $extensions) : void
    {
     ...
     * @param CompilerPassInterface[] $compilerPasses
     */
    private function registerCompilerPasses(\MonorepoBuilder20220124\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, array $compilerPasses) : void
    {
     ...
     * @param string[] $configFiles
     */
    private function registerConfigFiles(\MonorepoBuilder20220124\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder, array $configFiles) : void
    {
