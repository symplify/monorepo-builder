...
namespace MonorepoBuilder20220608\Symplify\SymplifyKernel\HttpKernel;
...
use MonorepoBuilder20220608\Symplify\AutowireArrayParameter\DependencyInjection\CompilerPass\AutowireArrayParameterCompilerPass;
...
use MonorepoBuilder20220608\Symplify\SymplifyKernel\Contract\LightKernelInterface;
use MonorepoBuilder20220608\Symplify\SymplifyKernel\Exception\ShouldNotHappenException;
use MonorepoBuilder20220608\Symplify\SymplifyKernel\ValueObject\SymplifyKernelConfig;
/**
 * @api
 */
abstract class AbstractSymplifyKernel implements LightKernelInterface
{
    ...
    public function getContainer() : \MonorepoBuilder20220608\Psr\Container\ContainerInterface
    {
