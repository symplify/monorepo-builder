...
namespace MonorepoBuilder20220218\Symplify\SmartFileSystem\Finder;
...
final class SmartFinder
{
    ...
    public function __construct(\MonorepoBuilder20220218\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \MonorepoBuilder20220218\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter)
    {
    ...
    public function findPaths(array $directoriesOrFiles, string $path) : array
    {
        ...
        $fileInfos = [];
        if ($directories !== []) {
            $finder = new \MonorepoBuilder20220218\Symfony\Component\Finder\Finder();
    ...
    public function find(array $directoriesOrFiles, string $name, array $excludedDirectories = []) : array
    {
        ...
        foreach ($files as $file) {
            $fileInfos[] = new \MonorepoBuilder20220218\Symplify\SmartFileSystem\SmartFileInfo($file);
        }
        return $fileInfos;
    }
}
