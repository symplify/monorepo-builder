...
namespace MonorepoBuilder20211107\Symplify\SmartFileSystem\Finder;
...
final class SmartFinder
{
    ...
    public function __construct(\MonorepoBuilder20211107\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \MonorepoBuilder20211107\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter)
    {
    ...
    public function find(array $directoriesOrFiles, string $name, array $excludedDirectories = []) : array
    {
        ...
        foreach ($files as $file) {
            $fileInfos[] = new \MonorepoBuilder20211107\Symplify\SmartFileSystem\SmartFileInfo($file);
        }
        return $fileInfos;
    }
}
