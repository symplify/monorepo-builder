...
namespace MonorepoBuilder20220317\Symplify\SmartFileSystem\Finder;
...
final class SmartFinder
{
    ...
    public function __construct(\MonorepoBuilder20220317\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \MonorepoBuilder20220317\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter)
    {
    ...
    public function findPaths(array $directoriesOrFiles, string $path) : array
    {
        ...
        $fileInfos = [];
        if ($directories !== []) {
            $finder = new \MonorepoBuilder20220317\Symfony\Component\Finder\Finder();
    ...
    public function find(array $directoriesOrFiles, string $name, array $excludedDirectories = []) : array
    {
        ...
        foreach ($files as $file) {
            $fileInfos[] = new \MonorepoBuilder20220317\Symplify\SmartFileSystem\SmartFileInfo($file);
        }
        return $fileInfos;
    }
}
