 ...
 */
final class SmartFileSystem extends \MonorepoBuilder20210827\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile($filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \MonorepoBuilder20210827\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    /**
     * @param string $filename
     */
    public function readFileToSmartFileInfo($filename) : \MonorepoBuilder20210827\Symplify\SmartFileSystem\SmartFileInfo
    {
        return new \MonorepoBuilder20210827\Symplify\SmartFileSystem\SmartFileInfo($filename);
    }
    /**
    ...
    private function getLastError() : string
    {
        ...
        return \MonorepoBuilder20210827\Nette\Utils\Strings::replace($htmlMessage, self::BEFORE_COLLON_REGEX, '');
    }
}
