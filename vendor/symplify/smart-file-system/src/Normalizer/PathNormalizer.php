...
namespace MonorepoBuilder20210919\Symplify\SmartFileSystem\Normalizer;
...
final class PathNormalizer
{
    ...
    {
        $matches = \MonorepoBuilder20210919\Nette\Utils\Strings::match($originalPath, self::SCHEME_PATH_REGEX);
        if ($matches !== null) {
            [, $scheme, $path] = $matches;
        } else {
        ...
        $path = \MonorepoBuilder20210919\Nette\Utils\Strings::replace($normalizedPath, self::TWO_AND_MORE_SLASHES_REGEX, '/');
