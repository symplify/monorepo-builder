...
use function max;
use SplFixedArray;
final class TimeEfficientLongestCommonSubsequenceCalculator implements \MonorepoBuilder20210805\SebastianBergmann\Diff\LongestCommonSubsequenceCalculator
{
    /**
     * {@inheritdoc}
     * @param mixed[] $from
