...
use function max;
final class MemoryEfficientLongestCommonSubsequenceCalculator implements \MonorepoBuilder20210809\SebastianBergmann\Diff\LongestCommonSubsequenceCalculator
{
    /**
     * {@inheritdoc}
     * @param mixed[] $from
