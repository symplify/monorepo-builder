...
use function max;
final class MemoryEfficientLongestCommonSubsequenceCalculator implements \MonorepoBuilder20210805\SebastianBergmann\Diff\LongestCommonSubsequenceCalculator
{
    /**
     * {@inheritdoc}
     * @param mixed[] $from
