 ...
 */
namespace MonorepoBuilder202208\Composer;

use MonorepoBuilder202208\Composer\Autoload\ClassLoader;
use MonorepoBuilder202208\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilder202208\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
