 ...
 */
namespace MonorepoBuilder202210\Composer;

use MonorepoBuilder202210\Composer\Autoload\ClassLoader;
use MonorepoBuilder202210\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilder202210\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
