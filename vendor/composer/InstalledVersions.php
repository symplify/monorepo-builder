 ...
 */
namespace MonorepoBuilder20220608\Composer;

use MonorepoBuilder20220608\Composer\Autoload\ClassLoader;
use MonorepoBuilder20220608\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilder20220608\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
