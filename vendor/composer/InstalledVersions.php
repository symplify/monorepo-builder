 ...
 */
namespace MonorepoBuilderPrefix202310\Composer;

use MonorepoBuilderPrefix202310\Composer\Autoload\ClassLoader;
use MonorepoBuilderPrefix202310\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilderPrefix202310\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
