 ...
 */
namespace MonorepoBuilderPrefix202308\Composer;

use MonorepoBuilderPrefix202308\Composer\Autoload\ClassLoader;
use MonorepoBuilderPrefix202308\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilderPrefix202308\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
