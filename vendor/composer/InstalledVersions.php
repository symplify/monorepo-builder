 ...
 */
namespace MonorepoBuilderPrefix202507\Composer;

use MonorepoBuilderPrefix202507\Composer\Autoload\ClassLoader;
use MonorepoBuilderPrefix202507\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilderPrefix202507\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
