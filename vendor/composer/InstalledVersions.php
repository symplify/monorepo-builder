 ...
 */
namespace MonorepoBuilder20211012\Composer;

use MonorepoBuilder20211012\Composer\Autoload\ClassLoader;
use MonorepoBuilder20211012\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilder20211012\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\MonorepoBuilder20211012\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
