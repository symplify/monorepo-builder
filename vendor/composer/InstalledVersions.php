 ...
 */
namespace MonorepoBuilder202209\Composer;

use MonorepoBuilder202209\Composer\Autoload\ClassLoader;
use MonorepoBuilder202209\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilder202209\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
