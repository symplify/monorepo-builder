 ...
 */
namespace MonorepoBuilder202207\Composer;

use MonorepoBuilder202207\Composer\Autoload\ClassLoader;
use MonorepoBuilder202207\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilder202207\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
