 ...
 */
namespace MonorepoBuilder202211\Composer;

use MonorepoBuilder202211\Composer\Autoload\ClassLoader;
use MonorepoBuilder202211\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilder202211\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
