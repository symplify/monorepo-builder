 ...
 */
namespace MonorepoBuilder202301\Composer;

use MonorepoBuilder202301\Composer\Autoload\ClassLoader;
use MonorepoBuilder202301\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilder202301\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
