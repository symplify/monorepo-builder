 ...
 */
namespace MonorepoBuilderPrefix202301\Composer;

use MonorepoBuilderPrefix202301\Composer\Autoload\ClassLoader;
use MonorepoBuilderPrefix202301\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilderPrefix202301\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
