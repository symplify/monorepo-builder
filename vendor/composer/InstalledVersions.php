 ...
 */
namespace MonorepoBuilderPrefix202304\Composer;

use MonorepoBuilderPrefix202304\Composer\Autoload\ClassLoader;
use MonorepoBuilderPrefix202304\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilderPrefix202304\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
