 ...
 */
namespace MonorepoBuilder202206\Composer;

use MonorepoBuilder202206\Composer\Autoload\ClassLoader;
use MonorepoBuilder202206\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilder202206\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
