 ...
 */
namespace MonorepoBuilder202212\Composer;

use MonorepoBuilder202212\Composer\Autoload\ClassLoader;
use MonorepoBuilder202212\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MonorepoBuilder202212\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
