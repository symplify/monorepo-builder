...
final class Neon
{
    public const BLOCK = \MonorepoBuilder20211103\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \MonorepoBuilder20211103\Nette\Neon\Encoder();
    ...
    public static function decode(string $input)
    {
        ...
        $decoder = new \MonorepoBuilder20211103\Nette\Neon\Decoder();
