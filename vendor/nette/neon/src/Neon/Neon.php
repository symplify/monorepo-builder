...
final class Neon
{
    public const BLOCK = \MonorepoBuilder20210927\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \MonorepoBuilder20210927\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \MonorepoBuilder20210927\Nette\Neon\Decoder();
