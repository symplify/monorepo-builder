...
final class Neon
{
    public const BLOCK = \MonorepoBuilder20210923\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \MonorepoBuilder20210923\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \MonorepoBuilder20210923\Nette\Neon\Decoder();
