...
final class Neon
{
    public const BLOCK = \MonorepoBuilder20220116\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \MonorepoBuilder20220116\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \MonorepoBuilder20220116\Nette\Neon\Decoder();
    ...
    {
        if (!\is_file($file)) {
            throw new \MonorepoBuilder20220116\Nette\Neon\Exception("File '{$file}' does not exist.");
        }
