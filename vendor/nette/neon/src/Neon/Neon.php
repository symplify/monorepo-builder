...
final class Neon
{
    public const BLOCK = \MonorepoBuilder20220527\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \MonorepoBuilder20220527\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \MonorepoBuilder20220527\Nette\Neon\Decoder();
    ...
    {
        if (!\is_file($file)) {
            throw new \MonorepoBuilder20220527\Nette\Neon\Exception("File '{$file}' does not exist.");
        }
