...
use MonorepoBuilder20220303\Nette\Neon;
use MonorepoBuilder20220303\Nette\Neon\Node;
/** @internal */
final class EntityChainNode extends \MonorepoBuilder20220303\Nette\Neon\Node
{
    /** @var EntityNode[] */
    public $chain = [];
    ...
    public function toValue() : \MonorepoBuilder20220303\Nette\Neon\Entity
    {
        ...
        return new \MonorepoBuilder20220303\Nette\Neon\Entity(\MonorepoBuilder20220303\Nette\Neon\Neon::CHAIN, $entities);
    }
