...
use MonorepoBuilder20211223\Nette\Neon;
use MonorepoBuilder20211223\Nette\Neon\Node;
/** @internal */
final class EntityChainNode extends \MonorepoBuilder20211223\Nette\Neon\Node
{
    /** @var EntityNode[] */
    public $chain = [];
    ...
    public function toValue() : \MonorepoBuilder20211223\Nette\Neon\Entity
    {
        ...
        return new \MonorepoBuilder20211223\Nette\Neon\Entity(\MonorepoBuilder20211223\Nette\Neon\Neon::CHAIN, $entities);
    }
