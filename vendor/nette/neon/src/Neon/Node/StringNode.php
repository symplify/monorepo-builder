...
/** @internal */
final class StringNode extends \MonorepoBuilder20211023\Nette\Neon\Node
{
    /** @var string */
    public $value;
    ...
    public function toString() : string
    {
        ...
        if ($res === \false) {
            throw new \MonorepoBuilder20211023\Nette\Neon\Exception('Invalid UTF-8 sequence: ' . $this->value);
        }
