...
class Helpers
{
    ...
    public static function getLastError() : string
    {
        ...
        $message = \ini_get('html_errors') ? \MonorepoBuilder20220606\Nette\Utils\Html::htmlToText($message) : $message;
    ...
    {
        if ($min > $max) {
            throw new \MonorepoBuilder20220606\Nette\InvalidArgumentException("Minimum ({$min}) is not less than maximum ({$max}).");
        }
