 ...
 */
namespace MonorepoBuilder20220525\cweagans\Composer;

use MonorepoBuilder20220525\Composer\Composer;
use MonorepoBuilder20220525\Composer\DependencyResolver\Operation\InstallOperation;
use MonorepoBuilder20220525\Composer\DependencyResolver\Operation\UninstallOperation;
use MonorepoBuilder20220525\Composer\DependencyResolver\Operation\UpdateOperation;
use MonorepoBuilder20220525\Composer\DependencyResolver\Operation\OperationInterface;
use MonorepoBuilder20220525\Composer\EventDispatcher\EventSubscriberInterface;
use MonorepoBuilder20220525\Composer\IO\IOInterface;
use MonorepoBuilder20220525\Composer\Package\AliasPackage;
use MonorepoBuilder20220525\Composer\Package\PackageInterface;
use MonorepoBuilder20220525\Composer\Plugin\PluginInterface;
use MonorepoBuilder20220525\Composer\Installer\PackageEvents;
use MonorepoBuilder20220525\Composer\Script\Event;
use MonorepoBuilder20220525\Composer\Script\ScriptEvents;
use MonorepoBuilder20220525\Composer\Installer\PackageEvent;
use MonorepoBuilder20220525\Composer\Util\ProcessExecutor;
use MonorepoBuilder20220525\Composer\Util\RemoteFilesystem;
use MonorepoBuilder20220525\Symfony\Component\Process\Process;
class Patches implements \MonorepoBuilder20220525\Composer\Plugin\PluginInterface, \MonorepoBuilder20220525\Composer\EventDispatcher\EventSubscriberInterface
{
    /**
     ...
     */
    public function activate(\MonorepoBuilder20220525\Composer\Composer $composer, \MonorepoBuilder20220525\Composer\IO\IOInterface $io)
    {
        $this->composer = $composer;
        $this->io = $io;
        $this->eventDispatcher = $composer->getEventDispatcher();
        $this->executor = new \MonorepoBuilder20220525\Composer\Util\ProcessExecutor($this->io);
        $this->patches = array();
    ...
    {
        return array(
            \MonorepoBuilder20220525\Composer\Script\ScriptEvents::PRE_INSTALL_CMD => array('checkPatches'),
            \MonorepoBuilder20220525\Composer\Script\ScriptEvents::PRE_UPDATE_CMD => array('checkPatches'),
            \MonorepoBuilder20220525\Composer\Installer\PackageEvents::PRE_PACKAGE_INSTALL => array('gatherPatches'),
            \MonorepoBuilder20220525\Composer\Installer\PackageEvents::PRE_PACKAGE_UPDATE => array('gatherPatches'),
            ...
            \MonorepoBuilder20220525\Composer\Installer\PackageEvents::POST_PACKAGE_INSTALL => array('postInstall', 10),
            \MonorepoBuilder20220525\Composer\Installer\PackageEvents::POST_PACKAGE_UPDATE => array('postInstall', 10),
        );
    }
    /**
     ...
     * @param Event $event
     */
    public function checkPatches(\MonorepoBuilder20220525\Composer\Script\Event $event)
    {
        ...
        try {
            ...
            $promises = array();
            foreach ($packages as $package) {
                if (!$package instanceof \MonorepoBuilder20220525\Composer\Package\AliasPackage) {
                    ...
                    if ($has_patches && !$has_applied_patches || !$has_patches && $has_applied_patches || $has_patches && $has_applied_patches && $tmp_patches[$package_name] !== $extra['patches_applied']) {
                        $uninstallOperation = new \MonorepoBuilder20220525\Composer\DependencyResolver\Operation\UninstallOperation($package, 'Removing package so it can be re-installed and re-patched.');
     ...
     */
    public function gatherPatches(\MonorepoBuilder20220525\Composer\Installer\PackageEvent $event)
    {
        // If we've already done this, then don't do it again.
        if (isset($this->patches['_patchesGathered'])) {
            $this->io->write('<info>Patches already gathered. Skipping</info>', TRUE, \MonorepoBuilder20220525\Composer\IO\IOInterface::VERBOSE);
            return;
        } elseif (!$this->isPatchingEnabled()) {
            $this->io->write('<info>Patching is disabled. Skipping.</info>', TRUE, \MonorepoBuilder20220525\Composer\IO\IOInterface::VERBOSE);
            return;
        }
        ...
        foreach ($operations as $operation) {
            if ($operation instanceof \MonorepoBuilder20220525\Composer\DependencyResolver\Operation\InstallOperation || $operation instanceof \MonorepoBuilder20220525\Composer\DependencyResolver\Operation\UpdateOperation) {
     ...
     * @throws \Exception
     */
    public function postInstall(\MonorepoBuilder20220525\Composer\Installer\PackageEvent $event)
    {
        ...
        // Set up a downloader.
        $downloader = new \MonorepoBuilder20220525\Composer\Util\RemoteFilesystem($this->io, $this->composer->getConfig());
        ...
        foreach ($this->patches[$package_name] as $description => $url) {
            ...
            try {
                $this->eventDispatcher->dispatch(NULL, new \MonorepoBuilder20220525\cweagans\Composer\PatchEvent(\MonorepoBuilder20220525\cweagans\Composer\PatchEvents::PRE_PATCH_APPLY, $package, $url, $description));
                $this->getAndApplyPatch($downloader, $install_path, $url, $package);
                $this->eventDispatcher->dispatch(NULL, new \MonorepoBuilder20220525\cweagans\Composer\PatchEvent(\MonorepoBuilder20220525\cweagans\Composer\PatchEvents::POST_PATCH_APPLY, $package, $url, $description));
     ...
     * @throws \Exception
     */
    protected function getPackageFromOperation(\MonorepoBuilder20220525\Composer\DependencyResolver\Operation\OperationInterface $operation)
    {
        if ($operation instanceof \MonorepoBuilder20220525\Composer\DependencyResolver\Operation\InstallOperation) {
            $package = $operation->getPackage();
        } elseif ($operation instanceof \MonorepoBuilder20220525\Composer\DependencyResolver\Operation\UpdateOperation) {
     ...
     * @throws \Exception
     */
    protected function getAndApplyPatch(\MonorepoBuilder20220525\Composer\Util\RemoteFilesystem $downloader, $install_path, $patch_url, \MonorepoBuilder20220525\Composer\Package\PackageInterface $package)
    {
        // Local patch file.
    ...
    protected function executeCommand($cmd)
    {
        ...
        if ($this->io->isVerbose()) {
            ...
            $output = function ($type, $data) use($io) {
                if ($type == \MonorepoBuilder20220525\Symfony\Component\Process\Process::ERR) {
     ...
     */
    public static function isPackagePatched(\MonorepoBuilder20220525\Composer\Package\PackageInterface $package)
    {
     ...
     * {@inheritDoc}
     */
    public function deactivate(\MonorepoBuilder20220525\Composer\Composer $composer, \MonorepoBuilder20220525\Composer\IO\IOInterface $io)
    {
    }
    /**
     * {@inheritDoc}
     */
    public function uninstall(\MonorepoBuilder20220525\Composer\Composer $composer, \MonorepoBuilder20220525\Composer\IO\IOInterface $io)
    {
    }
}
