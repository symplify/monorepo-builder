...
return static function (\MonorepoBuilder20210708\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->alias(\MonorepoBuilder20210708\Symfony\Component\Console\Application::class, \Symplify\MonorepoBuilder\Console\MonorepoBuilderConsoleApplication::class);
    ...
    $services->set(\MonorepoBuilder20210708\Symplify\PackageBuilder\Yaml\ParametersMerger::class);
};
