...
use MonorepoBuilder20220429\Symplify\SymplifyKernel\ValueObject\KernelBootAndApplicationRun;
# 1. autoload
...
$configFile = \MonorepoBuilder20220429\resolveConfigFile($argvInput);
if (\is_string($configFile)) {
    $configFiles[] = $configFile;
}
$kernelBootAndApplicationRun = new \MonorepoBuilder20220429\Symplify\SymplifyKernel\ValueObject\KernelBootAndApplicationRun(\Symplify\MonorepoBuilder\Kernel\MonorepoBuilderKernel::class, $configFiles);
$kernelBootAndApplicationRun->run();
function resolveConfigFile(\MonorepoBuilder20220429\Symfony\Component\Console\Input\ArgvInput $argvInput) : ?string
{
