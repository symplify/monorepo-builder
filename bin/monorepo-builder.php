...
use MonorepoBuilder20211106\Symplify\SymplifyKernel\ValueObject\KernelBootAndApplicationRun;
# 1. autoload
...
$configFile = \MonorepoBuilder20211106\resolveConfigFile($argvInput);
if (\is_string($configFile)) {
    $configFiles[] = $configFile;
}
$kernelBootAndApplicationRun = new \MonorepoBuilder20211106\Symplify\SymplifyKernel\ValueObject\KernelBootAndApplicationRun(\Symplify\MonorepoBuilder\Kernel\MonorepoBuilderKernel::class, $configFiles);
$kernelBootAndApplicationRun->run();
function resolveConfigFile(\MonorepoBuilder20211106\Symfony\Component\Console\Input\ArgvInput $argvInput) : ?string
{
